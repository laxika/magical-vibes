...
| `PermanentIsEnchantedByAuraControlledBySourceControllerPredicate` | `()` | permanents enchanted by at least one Aura controlled by the static effect's source controller — needs game data and static-effect source context. Used by Archon of the Wild Rose ("Other creatures you control that are enchanted by Auras you control …") |
