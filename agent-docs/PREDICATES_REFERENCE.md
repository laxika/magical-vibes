...
| `CardSharesCreatureTypeWithCommanderPredicate` | `()` | a creature card sharing a creature type with one of the perspective player's commanders; requires the `GameData` overload and honors Changeling/effective commander and card types (Path of Ancestry) |
