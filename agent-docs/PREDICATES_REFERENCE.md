...
| `CardSharesCreatureTypeWithSourcePredicate` | `()` | a card sharing a creature type with the source permanent; uses effective subtype characteristics and Changeling, including the source permanent snapshot if it has left the battlefield |
