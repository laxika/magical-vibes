...
| `PermanentPowerToughnessTotalAtMostPredicate` | `(int maxTotal)` | permanents with effective power plus toughness <= N; compose with `PermanentIsCreaturePredicate` for creature targets such as Cut Down |
