...
| ETB controls-another conditional damage | `g/GhituJourneymage.java` | ControlsAnotherPermanentConditionalEffect(PermanentHasSubtypePredicate(WIZARD), DealDamageToEachOpponentEffect(2)) — intervening-if another Wizard |
