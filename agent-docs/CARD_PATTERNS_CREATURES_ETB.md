...
| ETB metalcraft conditional drain | `b/BleakCovenVampires.java` | ConditionalEffect(new Metalcraft(), TargetPlayerLosesLifeAndControllerGainsLifeEffect) — intervening-if 3+ artifacts. Target is chosen at trigger time, never at cast (see TRIGGER_SLOT_TARGETING.md) |
