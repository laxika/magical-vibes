...
| `MustAttackThisTurnEffect` | `()` | target creature must attack this turn if able (one-shot, sets transient flag + mustAttackTargetId to ability controller, cleared at end of turn) |
