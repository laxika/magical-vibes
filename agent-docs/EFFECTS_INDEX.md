...
| `AllowCastFromCardsExiledWithSourceEffect` | `()` | static marker: "You may cast spells from among cards exiled with [this permanent]." Controller can cast any card tracked in `permanentExiledCards` for the source permanent. Used by Rona, Disciple of Gix |
