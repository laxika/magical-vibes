...
| `CreateTokenCopyOfImprintedCardEffect` | `()` | create a token that is a copy of the card imprinted on the source permanent. The token gains haste and is exiled at the beginning of the next end step |
