...
| `PutCounterOnSelfEffect` | `(CounterType counterType)` | put a counter of the specified type on this permanent (self-target). Supports CHARGE, STUDY, WISH, PLUS_ONE_PLUS_ONE, MINUS_ONE_MINUS_ONE. Used by Grimoire of the Dead (STUDY) |
