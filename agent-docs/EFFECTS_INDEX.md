...
| `BoostEnchantedCreatureEffect` | `(int powerBoost, int toughnessBoost)` | enchanted creature gets +X/+Y (static) |
| `BoostEquippedCreatureEffect` | `(int powerBoost, int toughnessBoost)` | equipped creature gets +X/+Y (static) |
