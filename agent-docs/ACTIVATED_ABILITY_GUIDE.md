...
| `OPENING_HAND_TRIGGERED` | Fires at the beginning of the first upkeep for cards in players' hands (Chancellor cycle). The card remains in hand. Used by Chancellor of the Dross |
