...
- `AllLandsAreCreaturesEffect(power, toughness)` — STATIC global: every land (both players') is a fixed-P/T creature that's still a land while the source is out (Nature's Revolt = 2/2). Reverts when it leaves; anthems/lords see the animated lands
