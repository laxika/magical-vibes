...
public class GameTestHarness {
    ...
    private static AttackLegalityService staticAttackLegalityService;
    ...
    private static synchronized void initServices() {
        ...
        ApplicationContext context = GameTestEngineContext.get();
        staticGameRegistry = context.getBean(TestGameRegistry.class);
        ...
        staticAttackLegalityService = context.getBean(AttackLegalityService.class);
    ...
    public GameTestHarness() {
        ...
        attackLegalityService = staticAttackLegalityService;
    ...
    public void castFromGraveyardWithSacrifice(Player player, int graveyardCardIndex, UUID sacrificePermanentId) {
        ensurePriority(player);
        gameService.playFlashbackSpell(gameData, player, graveyardCardIndex, null, null,
    ...
    /** Casts a modal sorcery while paying a conditional multi-permanent sacrifice cost. */
    public void castModalSorceryWithModesAndSacrifices(Player player, int cardIndex,
                                                       int choicesRequired, int choicesMax,
                                                       int[] modeIndices, List<UUID> sacrificePermanentIds) {
        ensurePriority(player);
        gameService.playCard(gameData, player, cardIndex,
                ChooseOneEffect.encodeModeSelection(choicesRequired, choicesMax, modeIndices),
    ...
    public void castSorcery(Player player, int cardIndex, Map<UUID, Integer> damageAssignments) {
        ensurePriority(player);
        gameService.playCard(gameData, player, cardIndex, 0, null, damageAssignments);
    }
    ...
    public void castFlashbackWithTapCost(Player player, int graveyardCardIndex, UUID targetId,
                                         List<UUID> tapPermanentIds) {
        ensurePriority(player);
    ...
    public void payLifeForColorlessMana(Player player) {
        ensurePriority(player);
    ...
    public AttackLegalityService getAttackLegalityService() {
        return attackLegalityService;
    }
