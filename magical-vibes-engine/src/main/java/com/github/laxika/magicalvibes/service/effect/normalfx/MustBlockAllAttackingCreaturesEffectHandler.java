...
public class MustBlockAllAttackingCreaturesEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return MustBlockAllAttackingCreaturesEffect.class;
    }
            ...
            for (List<Permanent> battlefield : gameData.playerBattlefields.values()) {
                for (Permanent permanent : battlefield) {
                    if (permanent.isAttacking()) {
                        target.getMustBlockIds().add(permanent.getId());
                    }
                }
            }
