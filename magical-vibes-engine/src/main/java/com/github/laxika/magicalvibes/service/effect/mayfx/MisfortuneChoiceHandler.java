...
/**
 * Misfortune: an opponent chooses one of two modes for the controller.
 */
@Component
@RequiredArgsConstructor
public class MisfortuneChoiceHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleMisfortuneChoice(gameData, player, accepted, ability);
    }
}
