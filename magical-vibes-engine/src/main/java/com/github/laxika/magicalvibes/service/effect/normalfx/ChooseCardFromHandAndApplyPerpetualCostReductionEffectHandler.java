...
public class ChooseCardFromHandAndApplyPerpetualCostReductionEffectHandler
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ChooseCardFromHandAndApplyPerpetualCostReductionEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        var e = (ChooseCardFromHandAndApplyPerpetualCostReductionEffect) effect;
        ...
        interactionHandlerRegistry.begin(gameData, new PendingInteraction.PerpetualPowerToughnessChoice(
                ...
                "Choose a matching card in your hand. It perpetually costs {" + e.amount()
                        + "} less to cast.", 0, 0, java.util.Set.of(), e.amount()));
    }
}
