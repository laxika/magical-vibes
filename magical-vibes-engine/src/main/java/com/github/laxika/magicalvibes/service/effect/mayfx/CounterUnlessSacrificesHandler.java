...
/** Handles ward's permanent-sacrifice ransom. */
@Component
@RequiredArgsConstructor
public class CounterUnlessSacrificesHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleCounterUnlessSacrificesChoice(gameData, player, accepted, ability);
    }
}
