...
public class SacrificeSelfAndTargetPlayerDiscardsEffectHandler implements NormalEffectHandlerBean {
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        // "Sacrifice it. If you do, defending player discards ..." — the discard is contingent on the
        // sacrifice happening, and the sacrifice must fire ally-sacrifice triggers and clean up
        // orphaned Auras exactly as SacrificeSelfEffectHandler does.
