...
public class PreventNextDamageFromChosenSourceAndGainLifeEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return PreventNextDamageFromChosenSourceAndGainLifeEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        gameData.interaction.setPermanentChoiceContext(
                new PermanentChoiceContext.PreventNextDamageFromSourceAndGainLifeChoice(controllerId));
