...
public class ExileTargetPermanentsAndControllersDrawEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ExileTargetPermanentsAndControllersDrawEffect.class;
    }
