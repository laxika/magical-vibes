...
/**
 * Handles the target creature controller's pay-or-bounce choice.
 */
@Component
@RequiredArgsConstructor
public class ReturnTargetCreatureUnlessControllerPaysHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleReturnTargetCreatureUnlessControllerPaysChoice(
