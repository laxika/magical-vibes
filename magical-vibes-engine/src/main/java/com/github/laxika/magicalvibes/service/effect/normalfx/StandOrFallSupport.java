...
public class StandOrFallSupport {
    ...
    public void completePileSeparationStep2(GameData gameData, boolean choosePile1) {
        ...
        gameData.blockableCreaturesThisTurn.merge(state.targetPlayerId(), Set.copyOf(chosen),
                (existing, next) -> {
        ...
        gameLogService.append(gameData, GameLog.text(playerName + " chooses " + pileName + " for blocking."));
    }
