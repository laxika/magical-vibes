...
public class RevealTopCardDrawManaValueEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return RevealTopCardDrawManaValueEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        log.info("Game {} - {} reveals {} (MV {}) via {} — card stays on top until drawn",
