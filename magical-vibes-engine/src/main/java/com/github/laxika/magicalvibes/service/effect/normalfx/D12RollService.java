...
/** Produces a random twelve-sided die result. */
@Component
public class D12RollService {

    public int roll() {
        return ThreadLocalRandom.current().nextInt(1, 13);
    }

    /** Rolls a d12 while applying each advantage replacement effect controlled by the player. */
