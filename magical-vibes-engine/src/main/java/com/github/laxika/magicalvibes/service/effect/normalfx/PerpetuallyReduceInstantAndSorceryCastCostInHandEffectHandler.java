...
/** Resolves Charged Conjuration's perpetual hand cost reduction. */
@Component
@RequiredArgsConstructor
public class PerpetuallyReduceInstantAndSorceryCastCostInHandEffectHandler
        implements NormalEffectHandlerBean {

    @Override
    public Class<? extends CardEffect> handledEffect() {
        return PerpetuallyReduceInstantAndSorceryCastCostInHandEffect.class;
    }
