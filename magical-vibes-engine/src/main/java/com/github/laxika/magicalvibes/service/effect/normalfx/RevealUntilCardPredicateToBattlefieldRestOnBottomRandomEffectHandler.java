...
public class RevealUntilCardPredicateToBattlefieldRestOnBottomRandomEffectHandler
    ...
    public Class<? extends CardEffect> handledEffect() {
        return RevealUntilCardPredicateToBattlefieldRestOnBottomRandomEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        var typedEffect = (RevealUntilCardPredicateToBattlefieldRestOnBottomRandomEffect) effect;
        ...
        if (foundCard != null && foundCard.hasType(CardType.CREATURE)) {
