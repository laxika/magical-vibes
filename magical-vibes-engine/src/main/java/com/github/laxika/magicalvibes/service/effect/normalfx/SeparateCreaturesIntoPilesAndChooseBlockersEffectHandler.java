...
@Slf4j
public class SeparateCreaturesIntoPilesAndChooseBlockersEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return SeparateCreaturesIntoPilesAndChooseBlockersEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        UUID activePlayerId = gameData.activePlayerId;
        UUID defendingPlayerId = gameQueryService.getOpponentId(gameData, activePlayerId);
