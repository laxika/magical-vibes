...
/** Resolves Ragavan, Nimble Pilferer's combat-damage trigger. */
@Slf4j
@Component
@RequiredArgsConstructor
public class ExileTopCardOfDamagedPlayerLibraryAndGrantCreatureControllerCastPermissionUntilEndOfTurnEffectHandler
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ExileTopCardOfDamagedPlayerLibraryAndGrantCreatureControllerCastPermissionUntilEndOfTurnEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        gameLogService.append(gameData, GameLog.builder()
                ...
                .text(creatureControllerName + " may cast it this turn.")
                .build());
        log.info("Game {} - {} exiles {} from {}'s library top; {} may cast it this turn",
