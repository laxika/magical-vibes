...
public class SacrificePermanentAndGrantKeywordSelfEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return SacrificePermanentAndGrantKeywordSelfEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        var e = (SacrificePermanentAndGrantKeywordSelfEffect) effect;
        ...
        if (battlefield != null) {
            for (Permanent permanent : battlefield) {
                if (predicateEvaluationService.matchesPermanentPredicate(permanent, e.sacrificeFilter(), filterContext)) {
        ...
        gameData.interaction.setPermanentChoiceContext(
                new PermanentChoiceContext.SacrificePermanentAndGrantKeywordSelf(
                        controllerId, entry.getCard(), entry.getSourcePermanentId(),
                        e.keywords(), e.permanentDescription()));
