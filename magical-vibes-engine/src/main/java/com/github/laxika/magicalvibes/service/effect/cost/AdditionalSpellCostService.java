...
public class AdditionalSpellCostService {
    ...
    public record ExtractedCosts(
        ...
        public boolean any() {
            return sacrificeAllCreatures || sacrificeAllPermanents || sacrificeCreature
                    ...
                    || exileGraveyardCost != null || exileXCardsCost != null || collectEvidenceCost != null
                    || exileNCardsCost != null
    ...
    public ExtractedCosts extractAndRemove(List<CardEffect> effects) {
        ...
        return new ExtractedCosts(sacAllCreatures, sacAllPermanents, sacCreature, sacOrPay, sacOrDiscard, permCost,
                ...
                payXLife, payLifeCost, exileGraveyardCost, exileXCardsCost, collectEvidenceCost, exileNCardsCost,
