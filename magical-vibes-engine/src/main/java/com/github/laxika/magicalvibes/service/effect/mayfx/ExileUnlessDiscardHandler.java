...
/** Exile-unless-discard — "unless you discard a [type] card, exile [source]". */
@Component
@RequiredArgsConstructor
public class ExileUnlessDiscardHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleExileUnlessDiscardChoice(gameData, player, accepted, ability);
    }
}
