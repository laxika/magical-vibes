...
public class ReturnAllCreaturesExceptChosenTypeToHandEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ReturnAllCreaturesExceptChosenTypeToHandEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        returnToHandEffectHandler.resolve(gameData, entry, ReturnToHandEffect.allPermanentsMatching(
