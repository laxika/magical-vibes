...
public class DamagedPlayerBecomesMonarchEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return DamagedPlayerBecomesMonarchEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        UUID playerId = entry.getTargetId();
        if (playerId == null || playerId.equals(gameData.monarchPlayerId)) {
            return;
        }
