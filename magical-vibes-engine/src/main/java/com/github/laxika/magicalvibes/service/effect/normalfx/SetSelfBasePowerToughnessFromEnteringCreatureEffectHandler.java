...
/**
 * Resolves the entering-creature reference carried by the enter-trigger may-ability and installs
 * the source's temporary base power and toughness.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class SetSelfBasePowerToughnessFromEnteringCreatureEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return SetSelfBasePowerToughnessFromEnteringCreatureEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        int power = gameQueryService.getEffectivePower(gameData, entering);
        int toughness = gameQueryService.getEffectiveToughness(gameData, entering);
