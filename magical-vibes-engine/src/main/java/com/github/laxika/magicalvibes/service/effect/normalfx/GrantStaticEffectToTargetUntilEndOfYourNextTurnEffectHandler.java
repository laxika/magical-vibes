...
public class GrantStaticEffectToTargetUntilEndOfYourNextTurnEffectHandler implements NormalEffectHandlerBean {

    private final GameQueryService gameQueryService;

    @Override
    public Class<? extends CardEffect> handledEffect() {
        return GrantStaticEffectToTargetUntilEndOfYourNextTurnEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        var grant = (GrantStaticEffectToTargetUntilEndOfYourNextTurnEffect) effect;
