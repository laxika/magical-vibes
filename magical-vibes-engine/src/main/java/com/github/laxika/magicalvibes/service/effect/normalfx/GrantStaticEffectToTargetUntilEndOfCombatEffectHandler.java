...
public class GrantStaticEffectToTargetUntilEndOfCombatEffectHandler implements NormalEffectHandlerBean {

    private final GameQueryService gameQueryService;

    @Override
    public Class<? extends CardEffect> handledEffect() {
        return GrantStaticEffectToTargetUntilEndOfCombatEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        var grant = (GrantStaticEffectToTargetUntilEndOfCombatEffect) effect;
        gameData.addFloatingEffect(new FloatingContinuousEffect(
                ...
                targetId, null, null, EffectDuration.UNTIL_END_OF_COMBAT, 0));
    }
}
