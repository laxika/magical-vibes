...
/**
 * Resolves the single atomic graveyard exile and source-counter effect.
 */
@Component
@RequiredArgsConstructor
public class ExileTargetCreatureCardFromGraveyardPutCounterOnSourceEffectHandler
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ExileTargetCreatureCardFromGraveyardPutCounterOnSourceEffect.class;
    }
