...
public class LookAtTopCardsOfTargetLibraryPutOneIntoGraveyardEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return LookAtTopCardsOfTargetLibraryPutOneIntoGraveyardEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        LookAtTopCardsOfTargetLibraryPutOneIntoGraveyardEffect e = (LookAtTopCardsOfTargetLibraryPutOneIntoGraveyardEffect) effect;
