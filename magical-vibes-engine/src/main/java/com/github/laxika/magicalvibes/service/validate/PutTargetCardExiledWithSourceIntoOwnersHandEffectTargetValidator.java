...
public class PutTargetCardExiledWithSourceIntoOwnersHandEffectTargetValidator {

    private final PredicateEvaluationService predicateEvaluationService;

    @ValidatesTarget(PutTargetCardExiledWithSourceIntoOwnersHandEffect.class)
    public void validate(TargetValidationContext ctx, PutTargetCardExiledWithSourceIntoOwnersHandEffect effect) {
        ...
        Permanent source = ctx.sourcePermanentSnapshot() != null
                ? ctx.sourcePermanentSnapshot() : findSourcePermanent(ctx.gameData(), ctx.sourceCard());
