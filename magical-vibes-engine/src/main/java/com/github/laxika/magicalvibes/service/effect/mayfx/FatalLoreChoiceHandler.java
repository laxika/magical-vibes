...
/**
 * Opponent chooses one of Fatal Lore's two modes for the controller.
 */
@Component
@RequiredArgsConstructor
public class FatalLoreChoiceHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleFatalLoreChoice(gameData, player, accepted, ability);
    }
}
