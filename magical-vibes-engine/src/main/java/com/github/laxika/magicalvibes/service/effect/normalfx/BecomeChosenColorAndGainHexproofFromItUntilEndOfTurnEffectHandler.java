...
public class BecomeChosenColorAndGainHexproofFromItUntilEndOfTurnEffectHandler
    ...
    public Class<? extends CardEffect> handledEffect() {
        return BecomeChosenColorAndGainHexproofFromItUntilEndOfTurnEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        interactionHandlerRegistry.begin(gameData, new PendingInteraction.ColorChoice(
                ...
                new ChoiceContext.BecomeChosenColorAndGainHexproofChoice(
                        targetId, entry.getControllerId(), entry.getCard().getName()),
