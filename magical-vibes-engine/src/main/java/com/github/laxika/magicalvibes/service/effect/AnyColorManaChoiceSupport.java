...
public final class AnyColorManaChoiceSupport {
    ...
    public static boolean beginColorChoice(InteractionHandlerRegistry interactionHandlerRegistry,
        ...
        if (recipientPlayerId != null) {
            ...
            } else if (choiceContext instanceof ChoiceContext.CommanderManaColorChoice commanderChoice) {
        ...
        List<ManaColor> allowedColors = switch (effect.restriction()) {
            ...
            case COMMANDER_COLOR_IDENTITY, COMMANDER_COLOR_IDENTITY_WITH_ENTRY_COUNTERS ->
        ...
        if (allowedColors.size() == 1
                ...
                || effect.restriction() == ManaSpendRestriction.COMMANDER_COLOR_IDENTITY_WITH_ENTRY_COUNTERS
            ...
            if (effect.restriction() == ManaSpendRestriction.CREATURE_COLORS_ABILITIES
                ...
                manaPool.add(effectiveColor, amount);
                if (effect.tracksProducingSourceForSpellCastTriggers() && sourcePermanentId != null) {
    ...
    private static ChoiceContext choiceContext(GameData gameData,
        ...
        ChoiceContext choice = switch (effect.restriction()) {
            ...
            case COMMANDER_COLOR_IDENTITY -> ChoiceContext.ManaColorChoice.fixedColorCombination(
                    ...
                    ManaProductionSupport.commanderColorIdentity(gameData, playerId));
            case COMMANDER_COLOR_IDENTITY_WITH_ENTRY_COUNTERS -> ChoiceContext.ManaColorChoice.fixedColorCombination(
                    playerId, fromCreature, amount,
                    ManaProductionSupport.commanderColorIdentity(gameData, playerId));
            case SPELL_ONLY ->
    ...
    private static String prompt(ManaSpendRestriction restriction) {
        return switch (restriction) {
            ...
            case COMMANDER_ONLY -> "Choose a color of mana to add (your commander only).";
