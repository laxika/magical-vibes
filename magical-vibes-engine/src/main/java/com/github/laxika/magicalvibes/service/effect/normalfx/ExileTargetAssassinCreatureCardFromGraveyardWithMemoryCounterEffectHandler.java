...
public class ExileTargetAssassinCreatureCardFromGraveyardWithMemoryCounterEffectHandler
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ExileTargetAssassinCreatureCardFromGraveyardWithMemoryCounterEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        if (targetCard == null || !predicateEvaluationService.matchesCardPredicate(
                targetCard,
                ExileTargetAssassinCreatureCardFromGraveyardWithMemoryCounterEffect.targetFilter(),
                entry.getCard().getId())) {
        ...
        if (graveyardReturnSupport.exileCardFromAnyGraveyard(gameData, targetCardId, targetCard)) {
            ...
            gameLogService.append(gameData,
                    GameLog.textCardText("Altaïr exiles ", targetCard, " with a memory counter on it."));
        }
    }
}
