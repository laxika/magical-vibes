...
/** Handles the spell controller's blight-a-creature-or-counter choice. */
@Component
@RequiredArgsConstructor
public class CounterUnlessBlightsHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleCounterUnlessBlightsChoice(
