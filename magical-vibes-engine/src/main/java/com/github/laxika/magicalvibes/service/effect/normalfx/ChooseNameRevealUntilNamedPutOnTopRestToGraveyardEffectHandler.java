...
public class ChooseNameRevealUntilNamedPutOnTopRestToGraveyardEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ChooseNameRevealUntilNamedPutOnTopRestToGraveyardEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        var choiceContext = new ChoiceContext.ChooseNameRevealUntilNamedPutOnTopRestToGraveyardChoice(
