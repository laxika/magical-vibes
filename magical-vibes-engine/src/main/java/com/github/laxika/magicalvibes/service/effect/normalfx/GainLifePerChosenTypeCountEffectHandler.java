...
/**
 * Resolves {@link GainLifePerChosenTypeCountEffect} (Luminescent Rain): prompts the controller to
 * choose a creature type, then gains {@code lifePerPermanent} life for each permanent the controller
 * controls of that type (Changeling-aware).
 *
 ...
 * {@code GameData.chosenSpellSubtype}, counts, and gains life. Mirrors
 * {@link DrawCardPerChosenTypeCountEffectHandler}.</p>
 */
@Component
@RequiredArgsConstructor
public class GainLifePerChosenTypeCountEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return GainLifePerChosenTypeCountEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        int lifePerPermanent = ((GainLifePerChosenTypeCountEffect) effect).lifePerPermanent();
        lifeSupport.applyGainLife(gameData, controllerId, count * lifePerPermanent,
