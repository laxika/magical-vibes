...
public class ChooseUpToTwoCreaturesDestroyRestEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return ChooseUpToTwoCreaturesDestroyRestEffect.class;
    }
    ...
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        ...
        destructionSupport.beginNextDestroyRestChoice(
                gameData,
                List.of(new PendingForcedSacrifice(entry.getControllerId(), 2, List.copyOf(creatureIds))),
                List.of(),
