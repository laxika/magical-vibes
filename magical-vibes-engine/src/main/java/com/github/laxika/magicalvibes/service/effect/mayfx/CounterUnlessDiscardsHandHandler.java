...
/** Handles the choice to discard a whole hand to prevent a spell from being countered. */
@Component
@RequiredArgsConstructor
public class CounterUnlessDiscardsHandHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleCounterUnlessDiscardsHandChoice(gameData, player, accepted, ability);
    }
}
