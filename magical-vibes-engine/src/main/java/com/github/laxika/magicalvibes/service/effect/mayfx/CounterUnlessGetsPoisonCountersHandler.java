...
/** Handles the spell controller's get-poison-counters-or-counter choice. */
@Component
@RequiredArgsConstructor
public class CounterUnlessGetsPoisonCountersHandler implements MayEffectHandlerBean {
    ...
    public void handle(GameData gameData, Player player, boolean accepted, PendingMayAbility ability) {
        mayPenaltyChoiceHandlerService.handleCounterUnlessGetsPoisonCountersChoice(
