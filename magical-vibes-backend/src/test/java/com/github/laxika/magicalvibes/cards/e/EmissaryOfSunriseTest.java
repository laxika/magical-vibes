...
class EmissaryOfSunriseTest extends BaseCardTest {
    ...
    void hasCorrectEffect() {
        EmissaryOfSunrise card = new EmissaryOfSunrise();
    ...
    void exploreLandNoCounter() {
        ...
        assertThat(emissary.getPlusOnePlusOneCounters()).isEqualTo(0);
    }
    ...
    void exploreNonLandAddsCounter() {
        ...
        Permanent emissary = findEmissary();
        assertThat(emissary).isNotNull();
        assertThat(emissary.getPlusOnePlusOneCounters()).isEqualTo(1);
    }
    ...
    private void castEmissary() {
        harness.setHand(player1, List.of(new EmissaryOfSunrise()));
