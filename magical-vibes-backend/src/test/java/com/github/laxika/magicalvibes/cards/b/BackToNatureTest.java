...
class BackToNatureTest extends BaseCardTest {
    ...
    void hasCorrectProperties() {
        ...
        assertThat(effect.targetTypes()).containsExactly(CardType.ENCHANTMENT);
    ...
    void castingPutsOnStack() {
        ...
        assertThat(entry.getCard().getName()).isEqualTo("Back to Nature");
    }
    ...
    void goesToGraveyardAfterResolving() {
        ...
        GameData gd = harness.getGameData();
        assertThat(gd.playerGraveyards.get(player1.getId()))
                .anyMatch(c -> c.getName().equals("Back to Nature"));
    }
}
