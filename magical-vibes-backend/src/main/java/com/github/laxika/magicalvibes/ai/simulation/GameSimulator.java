...
public class GameSimulator {
    ...
    public GameSimulator(GameQueryService sharedQueryService) {
        ...
        CombatService combatService = new CombatService(
                graveyardService, deathTriggerService, damagePreventionService, gameOutcomeService, gameQueryService, gameBroadcastService, playerInputService, noOpSession, permanentRemovalService, triggerCollectionService);
        ...
        List<Object> effectServices = List.of(
                ...
                new LibraryResolutionService(drawService, graveyardService, gameQueryService, gameBroadcastService, noOpSession, cardViewFactory),
        ...
        ActivatedAbilityExecutionService activatedAbilityExecutionService = new ActivatedAbilityExecutionService(
                graveyardService, deathTriggerService, damagePreventionService, permanentRemovalService, triggerCollectionService, stateBasedActionService, gameQueryService, gameBroadcastService, playerInputService, noOpSession);
        AbilityActivationService abilityActivationService = new AbilityActivationService(
                graveyardService, deathTriggerService, gameQueryService, gameBroadcastService, targetLegalityService, activatedAbilityExecutionService,
        ...
        MayAbilityHandlerService mayAbilityHandlerService = new MayAbilityHandlerService(
                drawService, gameQueryService, graveyardService, cloneService, stateBasedActionService, gameBroadcastService,
