...
public class CreateTokenPerEquipmentOnSourceEffectHandler implements NormalEffectHandlerBean {
    ...
    public Class<? extends CardEffect> handledEffect() {
        return CreateTokenPerEquipmentOnSourceEffect.class;
    }

    @Override
    public void resolve(GameData gameData, StackEntry entry, CardEffect effect) {
        var e = (CreateTokenPerEquipmentOnSourceEffect) effect;
                ...
                CreateTokenEffect tokenEffect = new CreateTokenEffect(
                        equipmentCount, e.tokenName(), e.power(), e.toughness(),
