...
- EFFECTS_INDEX.md — Complete lookup table of all 209 effects with constructor signatures, organized by category (damage, destruction, bounce, life, etc.). Always check here before creating a new effect.
