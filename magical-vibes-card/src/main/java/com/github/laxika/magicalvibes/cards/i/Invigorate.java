...
@CardRegistration(set = "CMD", collectorNumber = "162")
@CardRegistration(set = "SLZ", collectorNumber = "79")
@CardRegistration(set = "SLZ", collectorNumber = "200")
@CardRegistration(set = "SLZ", collectorNumber = "321")
