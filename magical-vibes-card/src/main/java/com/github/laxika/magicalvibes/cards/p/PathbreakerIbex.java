...
public class PathbreakerIbex extends Card {
    ...
    public PathbreakerIbex() {
        // Whenever this creature attacks, creatures you control gain trample and get +X/+X until
        // end of turn, where X is the greatest power among creatures you control.
