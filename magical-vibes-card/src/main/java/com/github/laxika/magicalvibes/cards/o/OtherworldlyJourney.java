...
@CardRegistration(set = "DDC", collectorNumber = "16")
@CardRegistration(set = "MM2", collectorNumber = "30")
@CardRegistration(set = "DVD", collectorNumber = "16")
@CardRegistration(set = "MMA", collectorNumber = "23")
