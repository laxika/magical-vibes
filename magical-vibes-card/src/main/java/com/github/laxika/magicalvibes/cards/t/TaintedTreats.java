...
@CardRegistration(set = "TMT", collectorNumber = "170")
public class TaintedTreats extends Card {

    public TaintedTreats() {
        var artifactOrCreature = new PermanentAnyOfPredicate(List.of(
                new PermanentIsArtifactPredicate(),
                new PermanentIsCreaturePredicate()));
        target(new PermanentPredicateTargetFilter(
                artifactOrCreature,
                "Target must be an artifact or creature")).addEffect(EffectSlot.SPELL,
