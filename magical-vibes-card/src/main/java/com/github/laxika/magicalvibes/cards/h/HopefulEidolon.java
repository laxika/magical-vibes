...
@CardRegistration(set = "THS", collectorNumber = "19")
@CardRegistration(set = "PIO", collectorNumber = "17")
public class HopefulEidolon extends Card {

    public HopefulEidolon() {
        addCastingOption(new BestowCast("{3}{W}"));
