...
@CardRegistration(set = "PLS", collectorNumber = "126")
public class Sparkcaster extends Card {

    public Sparkcaster() {
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, ReturnPermanentControlledByPlayerToHandEffect.controller(
