...
@CardRegistration(set = "AVR", collectorNumber = "31")
public class NearheathPilgrim extends Card {

    public NearheathPilgrim() {
        ...
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                new MayEffect(new SoulbondChoosePartnerEffect(),
                        "Pair Nearheath Pilgrim with another unpaired creature you control?"));
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceIsPaired(),
                new GrantKeywordEffect(Keyword.LIFELINK, GrantScope.SELF_AND_PAIRED)));
    }
}
