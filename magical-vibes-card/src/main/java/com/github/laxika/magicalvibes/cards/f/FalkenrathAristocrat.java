...
public class FalkenrathAristocrat extends Card {
    ...
    public FalkenrathAristocrat() {
        // Flying and haste are loaded automatically from Scryfall.

        // Sacrifice a creature: Falkenrath Aristocrat gains indestructible until end of turn.
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Sacrifice a Human: Falkenrath Aristocrat gains indestructible until end of turn and gets a +1/+1 counter."
        ));
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Sacrifice a non-Human creature: Falkenrath Aristocrat gains indestructible until end of turn."
        ));
    }
}
