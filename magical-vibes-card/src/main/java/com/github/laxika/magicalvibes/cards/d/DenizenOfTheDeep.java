...
public class DenizenOfTheDeep extends Card {
    ...
    public DenizenOfTheDeep() {
        super("Denizen of the Deep", CardType.CREATURE, "{6}{U}{U}", CardColor.BLUE);

        setSubtypes(List.of(CardSubtype.SERPENT));
        setCardText("When Denizen of the Deep enters the battlefield, return each other creature you control to its owner's hand.");
        setPower(11);
        setToughness(11);
