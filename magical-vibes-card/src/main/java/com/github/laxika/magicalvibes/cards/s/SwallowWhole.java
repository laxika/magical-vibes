...
@CardRegistration(set = "IKO", collectorNumber = "35")
public class SwallowWhole extends Card {

    public SwallowWhole() {
        addEffect(EffectSlot.SPELL, new TapMultiplePermanentsCost(1, new PermanentIsCreaturePredicate()));
