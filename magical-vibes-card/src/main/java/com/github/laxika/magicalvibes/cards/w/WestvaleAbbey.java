...
@CardRegistration(set = "SOI", collectorNumber = "281")
@CardRegistration(set = "SLD", collectorNumber = "1159")
@CardRegistration(set = "SLD", collectorNumber = "1212")
@CardRegistration(set = "SIR", collectorNumber = "275")
