...
@CardRegistration(set = "ALA", collectorNumber = "126")
public class CourtArchers extends Card {

    public CourtArchers() {
        // Reach is auto-loaded from Scryfall keywords; only Exalted needs engine logic.
