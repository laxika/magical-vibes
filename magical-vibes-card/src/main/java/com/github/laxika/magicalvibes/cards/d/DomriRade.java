...
@CardRegistration(set = "MM3", collectorNumber = "161")
@CardRegistration(set = "SLD", collectorNumber = "88")
@CardRegistration(set = "PIO", collectorNumber = "353")
@CardRegistration(set = "RVR", collectorNumber = "179")
