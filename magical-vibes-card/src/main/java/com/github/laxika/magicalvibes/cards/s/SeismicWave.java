...
@CardRegistration(set = "NEO", collectorNumber = "161")
public class SeismicWave extends Card {
    ...
    public SeismicWave() {
        ...
        target(anyTarget).addEffect(EffectSlot.SPELL, new DealDamageToAnyTargetEffect(2));
