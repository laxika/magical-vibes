...
@CardRegistration(set = "SUM", collectorNumber = "247")
@CardRegistration(set = "3ED", collectorNumber = "247")
@CardRegistration(set = "ME4", collectorNumber = "198")
@CardRegistration(set = "ARN", collectorNumber = "62")
