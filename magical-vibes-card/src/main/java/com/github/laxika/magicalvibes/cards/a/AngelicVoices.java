...
public class AngelicVoices extends Card {
    ...
    public AngelicVoices() {
        PermanentPredicate nonArtifactNonWhiteCreature = new PermanentAllOfPredicate(List.of(
        ...
        // As long as you control no nonartifact, nonwhite creatures, creatures you control get +1/+1.
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new ControlsPermanentCountAtMost(0, nonArtifactNonWhiteCreature),
