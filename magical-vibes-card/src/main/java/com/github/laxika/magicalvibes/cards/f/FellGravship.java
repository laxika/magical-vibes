...
@CardRegistration(set = "EOE", collectorNumber = "101")
public class FellGravship extends Card {

    public FellGravship() {
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, new MillControllerThenEffect(3,
