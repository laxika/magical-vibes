...
@CardRegistration(set = "ONE", collectorNumber = "184")
public class SylvokBattleChair extends Card {

    public SylvokBattleChair() {
        ...
        addActivatedAbility(new EquipActivatedAbility("{5}{G}{G}"));
    }
}
