...
@CardRegistration(set = "V13", collectorNumber = "3")
@CardRegistration(set = "EMA", collectorNumber = "92")
@CardRegistration(set = "SLC", collectorNumber = "8")
@CardRegistration(set = "SLC", collectorNumber = "35")
