...
@CardRegistration(set = "ECL", collectorNumber = "40")
public class TributaryVaulter extends Card {

    public TributaryVaulter() {
        ...
        target(new PermanentPredicateTargetFilter(
                ...
                "Target must be another Merfolk you control"
