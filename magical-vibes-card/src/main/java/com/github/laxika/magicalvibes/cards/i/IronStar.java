...
@CardRegistration(set = "5ED", collectorNumber = "379")
@CardRegistration(set = "4ED", collectorNumber = "326")
@CardRegistration(set = "3ED", collectorNumber = "252")
@CardRegistration(set = "2ED", collectorNumber = "251")
