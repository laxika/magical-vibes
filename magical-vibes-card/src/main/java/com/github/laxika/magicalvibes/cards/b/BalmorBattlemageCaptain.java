...
@CardRegistration(set = "FDN", collectorNumber = "237")
@CardRegistration(set = "DMU", collectorNumber = "196")
public class BalmorBattlemageCaptain extends Card {

    public BalmorBattlemageCaptain() {
