...
@CardRegistration(set = "CSP", collectorNumber = "93")
public class OhranYeti extends Card {

    public OhranYeti() {
        addActivatedAbility(new ActivatedAbility(false, "{2}{S}",
                ...
                new PermanentPredicateTargetFilter(
                        ...
                        "Target must be a snow creature"
                )));
    }
}
