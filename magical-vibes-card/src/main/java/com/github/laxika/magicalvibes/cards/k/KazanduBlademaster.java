...
@CardRegistration(set = "ZEN", collectorNumber = "16")
public class KazanduBlademaster extends Card {

    public KazanduBlademaster() {
        ...
        addEffect(EffectSlot.ON_SELF_OR_ALLY_CREATURE_ENTERS_BATTLEFIELD,
                new TriggeringCardConditionalEffect(new CardSubtypePredicate(CardSubtype.ALLY),
                        new MayEffect(new PutCountersOnSourceEffect(1, 1, 1),
                                "Put a +1/+1 counter on Kazandu Blademaster?")));
    }
}
