...
@CardRegistration(set = "UMA", collectorNumber = "153")
@CardRegistration(set = "EMA", collectorNumber = "152")
@CardRegistration(set = "MB1", collectorNumber = "152")
@CardRegistration(set = "DMR", collectorNumber = "146")
