...
@CardRegistration(set = "FIN", collectorNumber = "140")
public class HasteMagic extends Card {
    ...
    public HasteMagic() {
        target(TargetFilters.creature())
                ...
                .addEffect(EffectSlot.SPELL, new ExileTopCardsMayPlayUntilNextEndStepEffect(1));
    }
}
