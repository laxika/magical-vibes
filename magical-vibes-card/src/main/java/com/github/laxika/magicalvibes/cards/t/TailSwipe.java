...
@CardRegistration(set = "DMU", collectorNumber = "182")
public class TailSwipe extends Card {

    public TailSwipe() {
        // If cast during your main phase, the creature you control gets +1/+1 until end of turn.
        target(new ControlledPermanentPredicateTargetFilter(
                new PermanentIsCreaturePredicate(),
                "First target must be a creature you control"
        )).addEffect(EffectSlot.SPELL, new ConditionalEffect(
                new CastDuringMainPhase(), new BoostTargetCreatureEffect(1, 1)));
