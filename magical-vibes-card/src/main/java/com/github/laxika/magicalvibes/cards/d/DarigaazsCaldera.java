...
@CardRegistration(set = "PLS", collectorNumber = "137")
@CardRegistration(set = "DMR", collectorNumber = "243")
public class DarigaazsCaldera extends Card {

    public DarigaazsCaldera() {
