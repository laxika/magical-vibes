...
@CardRegistration(set = "WOE", collectorNumber = "165")
public class BraveTheWilds extends Card {

    public BraveTheWilds() {
        ...
        targetWhenKicked(TargetFilters.landYouControl(), 0, 0, 1, 1)
