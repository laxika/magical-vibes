...
@CardRegistration(set = "SLD", collectorNumber = "223")
@CardRegistration(set = "SLD", collectorNumber = "951")
@CardRegistration(set = "SLD", collectorNumber = "952")
@CardRegistration(set = "SLD", collectorNumber = "2188")
