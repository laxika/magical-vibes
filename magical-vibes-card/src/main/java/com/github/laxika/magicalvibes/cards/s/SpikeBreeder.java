...
@CardRegistration(set = "STH", collectorNumber = "116")
@CardRegistration(set = "TPR", collectorNumber = "194")
public class SpikeBreeder extends Card {
    ...
    public SpikeBreeder() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                List.of(
                        new RemoveCounterFromSourceCost(1, CounterType.PLUS_ONE_PLUS_ONE),
                        new CreateTokenEffect("Spike", 1, 1, CardColor.GREEN,
                                List.of(CardSubtype.SPIKE), Set.of(), Set.of())
                ),
                "{2}, Remove a +1/+1 counter from this creature: Create a 1/1 green Spike creature token."
        ));
    }
