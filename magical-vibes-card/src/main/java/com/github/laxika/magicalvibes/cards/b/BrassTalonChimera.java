...
@CardRegistration(set = "VIS", collectorNumber = "142")
public class BrassTalonChimera extends Card {
    ...
    public BrassTalonChimera() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                List.of(
                        ...
                        new GrantKeywordEffect(Keyword.FIRST_STRIKE, GrantScope.TARGET, GrantDuration.INDEFINITE)),
