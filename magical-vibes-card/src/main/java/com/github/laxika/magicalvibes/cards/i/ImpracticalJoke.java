...
@CardRegistration(set = "SOS", collectorNumber = "119")
public class ImpracticalJoke extends Card {

    public ImpracticalJoke() {
        ...
        ), 0, 1).addEffect(EffectSlot.SPELL, new DealDamageToTargetCreatureOrPlaneswalkerEffect(3));
    }
}
