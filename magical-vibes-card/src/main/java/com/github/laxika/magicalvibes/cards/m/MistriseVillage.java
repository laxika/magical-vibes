...
@CardRegistration(set = "TDM", collectorNumber = "261")
public class MistriseVillage extends Card {

    public MistriseVillage() {
        ...
        addActivatedAbility(new ActivatedAbility(
                true,
                "{U}",
                List.of(new MakeNextSpellUncounterableThisTurnEffect()),
