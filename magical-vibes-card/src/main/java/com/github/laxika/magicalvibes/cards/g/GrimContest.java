...
@CardRegistration(set = "FRF", collectorNumber = "153")
public class GrimContest extends Card {
    ...
    public GrimContest() {
        ...
        )).addEffect(EffectSlot.SPELL, new TargetCreaturesDealToughnessDamageToEachOtherEffect());
    }
}
