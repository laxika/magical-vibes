...
@CardRegistration(set = "EOE", collectorNumber = "242")
public class ExtinguisherBattleship extends Card {

    public ExtinguisherBattleship() {
        PermanentPredicate noncreaturePermanent =
                new PermanentNotPredicate(new PermanentIsCreaturePredicate());
        target(new PermanentPredicateTargetFilter(
                noncreaturePermanent,
                "Target must be a noncreature permanent"
        )).addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, new DestroyTargetPermanentEffect());
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, new MassDamageEffect(4));
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Tap another creature you control: Put charge counters equal to its power "
                        + "on this Spacecraft.",
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceCounterThreshold(5, CounterType.CHARGE),
                new GrantKeywordEffect(Set.of(Keyword.FLYING, Keyword.TRAMPLE), GrantScope.SELF)));
    }
}
