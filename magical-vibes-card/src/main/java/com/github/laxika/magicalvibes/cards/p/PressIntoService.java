...
@CardRegistration(set = "OGW", collectorNumber = "114")
public class PressIntoService extends Card {

    public PressIntoService() {
        setAllowSharedTargets(true);

        var controlTarget = target(TargetFilters.creature());
        var supportTargets = target(TargetFilters.creature(), 0, 2);
