...
public class SerraTheBenevolent extends Card {
    ...
    public SerraTheBenevolent() {
        ...
        addActivatedAbility(new ActivatedAbility(
                +2,
                List.of(new BoostAllOwnCreaturesEffect(1, 1, new PermanentAllOfPredicate(List.of(
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "\u22126: You get an emblem with \"If you control a creature, damage that would reduce your "
