...
@CardRegistration(set = "BOK", collectorNumber = "69")
public class HiredMuscle extends Card {

    public HiredMuscle() {
        setBackFaceCard(new Scarmaker());
        ...
        addEffect(EffectSlot.END_STEP_TRIGGERED,
                new ConditionalEffect(
                        ...
                        new MayEffect(new TransformToBackFaceEffect(), "Flip Hired Muscle?")));
    }
