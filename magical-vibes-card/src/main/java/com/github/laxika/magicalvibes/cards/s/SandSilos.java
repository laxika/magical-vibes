...
public class SandSilos extends Card {
    ...
    public SandSilos() {
        ...
        // {T}, Remove any number of storage counters from this land: Add {U} for each removed.
        addActivatedAbility(new ActivatedAbility(
                true, null,
                List.of(new RemoveCountersForManaEffect(ManaColor.BLUE, CounterType.STORAGE)),
