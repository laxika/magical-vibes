...
/**
 * Gore-House Chainwalker — {1}{R} Creature — Human Warrior 2/1 with unleash.
 * <p>
 ...
 */
@CardRegistration(set = "RTR", collectorNumber = "96")
public class GoreHouseChainwalker extends Card {
