...
@CardRegistration(set = "AKH", collectorNumber = "83")
@CardRegistration(set = "AKR", collectorNumber = "97")
public class CartoucheOfAmbition extends Card {

    public CartoucheOfAmbition() {
