...
@CardRegistration(set = "AVR", collectorNumber = "83")
@CardRegistration(set = "MM3", collectorNumber = "58")
public class Wingcrafter extends Card {
    ...
    public Wingcrafter() {
        ...
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                new MayEffect(new SoulbondChoosePartnerEffect(),
                        "Pair Wingcrafter with another unpaired creature you control?"));
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceIsPaired(),
                new GrantKeywordEffect(Keyword.FLYING, GrantScope.SELF_AND_PAIRED)));
    }
}
