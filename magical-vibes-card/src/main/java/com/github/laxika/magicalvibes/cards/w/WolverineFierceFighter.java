...
import com.github.laxika.magicalvibes.model.effect.HealPreviousDamageWhenDealtEffect;
...
@CardRegistration(set = "MSH", collectorNumber = "240")
public class WolverineFierceFighter extends Card {

    public WolverineFierceFighter() {
        ...
        addEffect(EffectSlot.STATIC, new HealPreviousDamageWhenDealtEffect());
    }
}
