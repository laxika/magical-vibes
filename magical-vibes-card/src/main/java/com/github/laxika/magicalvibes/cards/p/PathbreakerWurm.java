...
@CardRegistration(set = "AVR", collectorNumber = "188")
public class PathbreakerWurm extends Card {

    public PathbreakerWurm() {
        ...
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                new MayEffect(new SoulbondChoosePartnerEffect(),
                        "Pair Pathbreaker Wurm with another unpaired creature you control?"));
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceIsPaired(),
                new GrantKeywordEffect(Keyword.TRAMPLE, GrantScope.SELF_AND_PAIRED)));
    }
}
