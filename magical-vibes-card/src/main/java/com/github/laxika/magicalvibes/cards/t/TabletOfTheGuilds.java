...
import com.github.laxika.magicalvibes.model.effect.ChooseTwoColorsOnEnterEffect;
...
public class TabletOfTheGuilds extends Card {
    ...
    public TabletOfTheGuilds() {
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, new ChooseTwoColorsOnEnterEffect());
