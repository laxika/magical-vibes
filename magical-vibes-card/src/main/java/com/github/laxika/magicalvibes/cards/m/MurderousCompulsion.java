...
@CardRegistration(set = "INR", collectorNumber = "126")
@CardRegistration(set = "SOI", collectorNumber = "126")
public class MurderousCompulsion extends Card {

    public MurderousCompulsion() {
