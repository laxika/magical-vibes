...
@CardRegistration(set = "JOU", collectorNumber = "102")
public class LightningDiadem extends Card {

    public LightningDiadem() {
        // The enchant target and the ETB damage target may be the same creature.
