...
public class NahiriTheLithomancer extends Card {
    ...
    public NahiriTheLithomancer() {
        CreateTokenEffect korSoldier = new CreateTokenEffect(
                "Kor Soldier", 1, 1, com.github.laxika.magicalvibes.model.CardColor.WHITE,
        ...
        CreateTokenEffect stoneforgedBlade = new CreateTokenEffect(
                CardType.ARTIFACT, 1, "Stoneforged Blade", 0, 0, null, null,
                List.of(CardSubtype.EQUIPMENT), Set.of(Keyword.INDESTRUCTIBLE), Set.of(), false, false,
                Map.of(EffectSlot.STATIC, new StaticBoostEffect(
                        5, 5, Set.of(Keyword.DOUBLE_STRIKE), GrantScope.EQUIPPED_CREATURE)),
                List.of(new EquipActivatedAbility("{0}")), false, false, false, 0, Set.of());
        addActivatedAbility(new ActivatedAbility(
                -10,
