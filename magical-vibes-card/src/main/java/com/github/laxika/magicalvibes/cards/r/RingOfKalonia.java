...
@CardRegistration(set = "M13", collectorNumber = "212")
public class RingOfKalonia extends Card {

    public RingOfKalonia() {
        ...
        addEffect(EffectSlot.UPKEEP_TRIGGERED, new PutCounterOnReferencedPermanentEffect(
                CounterType.PLUS_ONE_PLUS_ONE, 1, new PermanentColorInPredicate(Set.of(CardColor.GREEN))));
