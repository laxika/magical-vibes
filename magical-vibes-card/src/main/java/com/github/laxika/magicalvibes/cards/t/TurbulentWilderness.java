...
@CardRegistration(set = "SOC", collectorNumber = "59")
@CardRegistration(set = "SOC", collectorNumber = "107")
public class TurbulentWilderness extends Card {

    public TurbulentWilderness() {
