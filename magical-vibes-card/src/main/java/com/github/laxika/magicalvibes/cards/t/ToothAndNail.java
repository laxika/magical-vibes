...
@CardRegistration(set = "HA7", collectorNumber = "15")
@CardRegistration(set = "CMM", collectorNumber = "327")
@CardRegistration(set = "CMM", collectorNumber = "574")
@CardRegistration(set = "CMM", collectorNumber = "652")
