...
@CardRegistration(set = "WAR", collectorNumber = "112")
public class VraskasFinisher extends Card {

    public VraskasFinisher() {
        target(new PermanentPredicateTargetFilter(
                ...
                "Target must be a creature or planeswalker an opponent controls that was dealt damage this turn"
