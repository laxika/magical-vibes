...
@CardRegistration(set = "4ED", collectorNumber = "298")
@CardRegistration(set = "LEG", collectorNumber = "274")
public class BlackManaBattery extends Card {
    ...
    public BlackManaBattery() {
        ...
        // additional {B} for each charge counter removed this way. The base {B} and the per-counter
        // {B} are two mana-producing effects; the first adds the guaranteed {B}, the second prompts
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                List.of(new AwardManaEffect(ManaColor.BLACK, 1),
                        new RemoveCountersForManaEffect(ManaColor.BLACK, CounterType.CHARGE)),
