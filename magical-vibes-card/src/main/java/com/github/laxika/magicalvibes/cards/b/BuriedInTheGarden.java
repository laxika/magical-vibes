...
@CardRegistration(set = "MKM", collectorNumber = "191")
@CardRegistration(set = "OTP", collectorNumber = "38")
public class BuriedInTheGarden extends Card {

    public BuriedInTheGarden() {
