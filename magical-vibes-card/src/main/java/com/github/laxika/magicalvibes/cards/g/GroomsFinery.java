...
@CardRegistration(set = "VOW", collectorNumber = "117")
@CardRegistration(set = "DBL", collectorNumber = "384")
public class GroomsFinery extends Card {
    ...
    public GroomsFinery() {
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new AnyPlayerControlsPermanent(new PermanentAllOfPredicate(List.of(
                        ...
                        new PermanentNamedPredicate("Bride's Gown"),
                        new PermanentAttachedToCreatureControlledBySourceControllerPredicate()))),
                new StaticBoostEffect(0, 2, Set.of(Keyword.DEATHTOUCH), GrantScope.EQUIPPED_CREATURE)));
