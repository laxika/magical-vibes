...
@CardRegistration(set = "SOS", collectorNumber = "204")
public class MoltenNote extends Card {
    ...
    public MoltenNote() {
        target(new PermanentPredicateTargetFilter(
                ...
                .addEffect(EffectSlot.SPELL, new DealDamageToTargetCreatureEqualToManaSpentToCastEffect())
                .addEffect(EffectSlot.SPELL, new UntapAllControlledPermanentsEffect(new PermanentIsCreaturePredicate()));
        addCastingOption(new FlashbackCast("{6}{R}{W}"));
    }
}
