...
@CardRegistration(set = "SOC", collectorNumber = "58")
@CardRegistration(set = "SOC", collectorNumber = "106")
public class TurbulentSteppe extends Card {

    public TurbulentSteppe() {
