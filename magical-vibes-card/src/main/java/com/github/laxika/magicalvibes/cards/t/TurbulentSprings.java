...
@CardRegistration(set = "SOC", collectorNumber = "57")
@CardRegistration(set = "SOC", collectorNumber = "105")
public class TurbulentSprings extends Card {

    public TurbulentSprings() {
