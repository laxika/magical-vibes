...
@CardRegistration(set = "DTK", collectorNumber = "147")
public class LoseCalm extends Card {
    ...
    public LoseCalm() {
        target(TargetFilters.creature())
                ...
                .addEffect(EffectSlot.SPELL, new GrantKeywordEffect(Keyword.MENACE, GrantScope.TARGET));
    }
}
