...
@CardRegistration(set = "EMN", collectorNumber = "137")
@CardRegistration(set = "SIR", collectorNumber = "171")
public class NahirisWrath extends Card {

    public NahirisWrath() {
        addEffect(EffectSlot.SPELL, new DiscardXCardsCost(true));
        targetX(new PermanentPredicateTargetFilter(
                ...
                DealDamageToEachTargetEffect.creaturesOrPlaneswalkers(new XValue()));
    }
}
