...
@CardRegistration(set = "M13", collectorNumber = "91")
public class DuskmantleProwler extends Card {

    public DuskmantleProwler() {
        // Haste is auto-loaded from Scryfall keywords. Exalted: whenever a creature you control
