...
@CardRegistration(set = "MKM", collectorNumber = "98")
@CardRegistration(set = "MKM", collectorNumber = "345")
public class PersuasiveInterrogators extends Card {

    public PersuasiveInterrogators() {
