...
@CardRegistration(set = "NPH", collectorNumber = "150")
@CardRegistration(set = "DDE", collectorNumber = "14")
@CardRegistration(set = "7ED", collectorNumber = "312")
...
@CardRegistration(set = "TPR", collectorNumber = "230")
