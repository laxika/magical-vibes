...
@CardRegistration(set = "WAR", collectorNumber = "94")
public class KayasGhostform extends Card {

    public KayasGhostform() {
        ...
        addEffect(EffectSlot.ON_ENCHANTED_PERMANENT_LEAVES_BATTLEFIELD,
                new ReturnEnchantedPermanentToBattlefieldOnDeathOrExileEffect());
    }
}
