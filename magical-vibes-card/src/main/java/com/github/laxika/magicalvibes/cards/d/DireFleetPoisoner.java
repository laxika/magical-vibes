...
@CardRegistration(set = "RIX", collectorNumber = "68")
public class DireFleetPoisoner extends Card {

    public DireFleetPoisoner() {
        target(new ControlledPermanentPredicateTargetFilter(
                ...
                "Target must be an attacking Pirate you control"
        ))
