...
@CardRegistration(set = "MMQ", collectorNumber = "319")
public class HickoryWoodlot extends Card {

    public HickoryWoodlot() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "{T}, Remove a depletion counter from Hickory Woodlot: Add {G}{G}. If there are no depletion counters on it, sacrifice it."
        ));
    }
}
