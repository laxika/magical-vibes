...
@CardRegistration(set = "CHK", collectorNumber = "101")
public class AshenSkinZubera extends Card {

    public AshenSkinZubera() {
        // When this creature dies, target opponent discards a card for each Zubera that died this turn.
        target(new PlayerPredicateTargetFilter(
                new PlayerRelationPredicate(PlayerRelation.OPPONENT),
                "Target must be an opponent"
        )).addEffect(EffectSlot.ON_DEATH, new DiscardEffect(
