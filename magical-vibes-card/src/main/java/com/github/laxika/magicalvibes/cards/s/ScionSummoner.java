...
@CardRegistration(set = "OGW", collectorNumber = "123")
public class ScionSummoner extends Card {
    ...
    public ScionSummoner() {
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, SCION_TOKEN);
    }
}
