...
@CardRegistration(set = "EOE", collectorNumber = "167")
public class WarmakerGunship extends Card {

    public WarmakerGunship() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Tap another creature you control: Put charge counters equal to its power on Warmaker Gunship.",
                ActivationTimingRestriction.SORCERY_SPEED
        ));

        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceCounterThreshold(6, CounterType.CHARGE),
