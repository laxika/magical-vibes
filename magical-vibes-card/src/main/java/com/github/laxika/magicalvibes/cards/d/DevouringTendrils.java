...
@CardRegistration(set = "STX", collectorNumber = "126")
public class DevouringTendrils extends Card {

    public DevouringTendrils() {
        ...
        target(new PermanentPredicateTargetFilter(
                ...
                .addEffect(EffectSlot.SPELL, new ResolveEffectOnTargetDeathThisTurnEffect(new GainLifeEffect(2)));
    }
}
