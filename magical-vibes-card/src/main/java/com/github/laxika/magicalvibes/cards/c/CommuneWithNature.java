...
@CardRegistration(set = "MM2", collectorNumber = "142")
public class CommuneWithNature extends Card {

    public CommuneWithNature() {
        addEffect(EffectSlot.SPELL, LookAtTopCardsEffect.mayRevealOneToHandRestOnBottom(5, new CardTypePredicate(CardType.CREATURE)));
    }
}
