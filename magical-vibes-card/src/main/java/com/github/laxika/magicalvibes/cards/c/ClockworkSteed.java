...
@CardRegistration(set = "5ED", collectorNumber = "357")
@CardRegistration(set = "HML", collectorNumber = "103")
@CardRegistration(set = "ME2", collectorNumber = "205")
public class ClockworkSteed extends Card {

    public ClockworkSteed() {
        ...
        // This creature can't be blocked by artifact creatures. Blockers are creatures, so an artifact
        // blocker is an artifact creature.
        ...
        addActivatedAbility(new ActivatedAbility(true, "{X}",
                List.of(new PutCappedCountersOnSourceEffect(CounterType.PLUS_ONE_PLUS_ZERO, new XValue(), 4)),
                "{X}, {T}: Put up to X +1/+0 counters on this creature. This ability can't cause the "
                        + "total number of +1/+0 counters on this creature to be greater than four. "
