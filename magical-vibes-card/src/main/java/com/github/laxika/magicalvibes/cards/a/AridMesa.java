...
@CardRegistration(set = "SLU", collectorNumber = "4")
@CardRegistration(set = "SPG", collectorNumber = "109")
@CardRegistration(set = "SPG", collectorNumber = "114")
@CardRegistration(set = "MH2", collectorNumber = "244")
