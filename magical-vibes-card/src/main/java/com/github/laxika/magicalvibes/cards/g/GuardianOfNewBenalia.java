...
@CardRegistration(set = "DMU", collectorNumber = "19")
public class GuardianOfNewBenalia extends Card {

    public GuardianOfNewBenalia() {
        addEffect(EffectSlot.STATIC, new ScryWhenThisCreatureEnlistsEffect());
