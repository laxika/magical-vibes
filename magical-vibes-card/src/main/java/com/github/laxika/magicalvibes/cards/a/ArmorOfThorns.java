...
@CardRegistration(set = "MIR", collectorNumber = "206")
@CardRegistration(set = "VMA", collectorNumber = "194")
public class ArmorOfThorns extends Card {

    public ArmorOfThorns() {
        // Enchant nonblack creature; the enchanted creature gets +2/+2. The Mirage flash clause lets
        // it be cast at instant speed at the cost of being sacrificed at the next cleanup step.
