...
@CardRegistration(set = "TDM", collectorNumber = "233")
public class UreniTheSongUnending extends Card {

    public UreniTheSongUnending() {
        ...
        ), 0, 99).addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, new DealDividedDamageEffect(
