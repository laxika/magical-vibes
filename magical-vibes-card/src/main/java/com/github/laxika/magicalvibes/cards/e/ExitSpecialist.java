...
@CardRegistration(set = "MKM", collectorNumber = "55")
public class ExitSpecialist extends Card {

    public ExitSpecialist() {
        addMorph("{1}{U}");
        ...
        )).addEffect(EffectSlot.ON_TURNED_FACE_UP, ReturnToHandEffect.target());
    }
}
