...
@CardRegistration(set = "BRO", collectorNumber = "265")
public class MishrasFoundry extends Card {

    public MishrasFoundry() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                new PermanentPredicateTargetFilter(
                        new PermanentAllOfPredicate(List.of(
                                ...
                                new PermanentIsCreaturePredicate(),
                                new PermanentHasSubtypePredicate(CardSubtype.ASSEMBLY_WORKER))),
                        "Target must be an attacking Assembly-Worker creature"
                )
        ));
    }
}
