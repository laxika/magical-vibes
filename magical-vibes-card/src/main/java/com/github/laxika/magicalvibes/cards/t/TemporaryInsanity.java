...
@CardRegistration(set = "TOR", collectorNumber = "116")
@CardRegistration(set = "DDG", collectorNumber = "73")
public class TemporaryInsanity extends Card {
    ...
    public TemporaryInsanity() {
        target(new PermanentPredicateTargetFilter(
                ...
                "Target must be a creature with power less than the number of cards in your graveyard"
