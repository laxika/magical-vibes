...
@CardRegistration(set = "BOK", collectorNumber = "99")
public class CunningBandit extends Card {

    public CunningBandit() {
        setBackFaceCard(new AzamukiTreacheryIncarnate());
    ...
    public String getBackFaceClassName() {
        return "AzamukiTreacheryIncarnate";
    }
}
