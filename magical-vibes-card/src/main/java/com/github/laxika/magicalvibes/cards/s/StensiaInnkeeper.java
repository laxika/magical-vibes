...
@CardRegistration(set = "EMN", collectorNumber = "145")
public class StensiaInnkeeper extends Card {

    public StensiaInnkeeper() {
        target(TargetFilters.landAnOpponentControls())
