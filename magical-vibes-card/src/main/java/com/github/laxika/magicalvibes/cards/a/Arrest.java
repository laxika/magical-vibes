...
@CardRegistration(set = "MRD", collectorNumber = "2")
@CardRegistration(set = "MMQ", collectorNumber = "4")
@CardRegistration(set = "TD2", collectorNumber = "32")
@CardRegistration(set = "MM2", collectorNumber = "9")
