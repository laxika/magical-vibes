...
@CardRegistration(set = "GN2", collectorNumber = "39")
@CardRegistration(set = "GN3", collectorNumber = "71")
@CardRegistration(set = "IMA", collectorNumber = "124")
@CardRegistration(set = "EMA", collectorNumber = "126")
