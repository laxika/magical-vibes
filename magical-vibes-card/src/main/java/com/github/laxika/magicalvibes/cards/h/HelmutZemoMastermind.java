...
@CardRegistration(set = "MSC", collectorNumber = "32")
@CardRegistration(set = "MSC", collectorNumber = "331")
public class HelmutZemoMastermind extends Card {

    public HelmutZemoMastermind() {
