...
@CardRegistration(set = "AVR", collectorNumber = "179")
public class GeistTrappers extends Card {

    public GeistTrappers() {
        ...
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                new MayEffect(new SoulbondChoosePartnerEffect(),
                        "Pair Geist Trappers with another unpaired creature you control?"));
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceIsPaired(),
                new GrantKeywordEffect(Keyword.REACH, GrantScope.SELF_AND_PAIRED)));
    }
}
