...
@CardRegistration(set = "USG", collectorNumber = "37")
public class RuneOfProtectionBlue extends Card {

    public RuneOfProtectionBlue() {
        addActivatedAbility(new ActivatedAbility(
                false,
                "{W}",
                List.of(PreventDamageFromChosenSourceEffect.nextDamageToYou(
                        new PermanentColorInPredicate(Set.of(CardColor.BLUE)), "blue")),
