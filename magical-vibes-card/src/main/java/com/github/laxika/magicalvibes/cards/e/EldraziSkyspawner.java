...
@CardRegistration(set = "BFZ", collectorNumber = "58")
public class EldraziSkyspawner extends Card {
    ...
    public EldraziSkyspawner() {
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, ELDRAZI_SCION);
    }
}
