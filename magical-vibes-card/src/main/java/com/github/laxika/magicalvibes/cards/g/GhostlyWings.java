...
@CardRegistration(set = "SOI", collectorNumber = "66")
public class GhostlyWings extends Card {
    ...
    public GhostlyWings() {
        ...
        addActivatedAbility(new ActivatedAbility(
                false,
                null,
                List.of(new DiscardCardTypeCost(null, null), ReturnToHandEffect.enchanted()),
