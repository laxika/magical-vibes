...
@CardRegistration(set = "YEOE", collectorNumber = "11")
public class MonoistGravliner extends Card {

    public MonoistGravliner() {
        addEffect(EffectSlot.ON_SELF_BECOMES_STATIONED,
                new PerpetuallyGrantKeywordsToStationingCreatureEffect(
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Tap another untapped creature you control: Put charge counters equal to its power on Monoist Gravliner.",
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                ...
                new GrantKeywordEffect(
                        Set.of(Keyword.FLYING, Keyword.DEATHTOUCH, Keyword.LIFELINK), GrantScope.SELF)));
    }
}
