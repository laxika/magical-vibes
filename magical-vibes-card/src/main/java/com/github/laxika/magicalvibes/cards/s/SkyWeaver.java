...
@CardRegistration(set = "INV", collectorNumber = "74")
public class SkyWeaver extends Card {

    public SkyWeaver() {
        addActivatedAbility(new ActivatedAbility(false, "{2}", List.of(new GrantKeywordEffect(Keyword.FLYING, GrantScope.TARGET)),
