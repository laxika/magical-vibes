...
@CardRegistration(set = "SOC", collectorNumber = "14")
@CardRegistration(set = "SOC", collectorNumber = "64")
public class ForumFilibuster extends Card {

    public ForumFilibuster() {
        addEffect(EffectSlot.UPKEEP_TRIGGERED, new CreateTokenThenEffect(
