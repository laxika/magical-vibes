...
@CardRegistration(set = "SLD", collectorNumber = "163")
@CardRegistration(set = "SLD", collectorNumber = "2251")
@CardRegistration(set = "CMM", collectorNumber = "181")
@CardRegistration(set = "CMM", collectorNumber = "520")
