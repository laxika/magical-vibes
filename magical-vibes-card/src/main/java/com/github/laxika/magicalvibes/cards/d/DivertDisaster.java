...
@CardRegistration(set = "EOE", collectorNumber = "55")
public class DivertDisaster extends Card {
    ...
    public DivertDisaster() {
        addEffect(EffectSlot.SPELL, new CounterUnlessPaysEffect(2, List.of(LANDER)));
    }
}
