...
@CardRegistration(set = "STX", collectorNumber = "198")
public class LoreholdApprentice extends Card {

    public LoreholdApprentice() {
        ...
        List<CardEffect> magecraft = List.of(new GrantActivatedAbilityEffect(
                damageAbility,
