...
@CardRegistration(set = "HOB", collectorNumber = "61")
public class AzogMoriasRuin extends Card {

    public AzogMoriasRuin() {
        ...
        target(new PermanentPredicateTargetFilter(otherCreature, "Target must be another creature"), 0, 1)
                .addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                        new DestroyTargetCreatureThenAmassGoblinsEffect());
    }
}
