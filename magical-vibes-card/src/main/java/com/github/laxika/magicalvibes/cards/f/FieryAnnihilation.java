...
@CardRegistration(set = "FDN", collectorNumber = "86")
public class FieryAnnihilation extends Card {

    public FieryAnnihilation() {
        setMultiTargetConstraint(MultiTargetConstraint.ATTACHED_TO_FIRST_TARGET);
