...
@CardRegistration(set = "M21", collectorNumber = "166")
public class TraitorousGreed extends Card {

    public TraitorousGreed() {
        ...
        addEffect(EffectSlot.SPELL, new AwardAnyColorManaEffect(2));
    }
}
