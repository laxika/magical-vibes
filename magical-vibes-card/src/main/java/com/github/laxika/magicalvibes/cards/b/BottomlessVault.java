...
public class BottomlessVault extends Card {
    ...
    public BottomlessVault() {
        ...
        // {T}, Remove any number of storage counters from this land: Add {B} for each removed.
        addActivatedAbility(new ActivatedAbility(
                true, null,
                List.of(new RemoveCountersForManaEffect(ManaColor.BLACK, CounterType.STORAGE)),
