...
@CardRegistration(set = "M14", collectorNumber = "112")
@CardRegistration(set = "IMA", collectorNumber = "107")
@CardRegistration(set = "SLD", collectorNumber = "1799")
@CardRegistration(set = "SLD", collectorNumber = "2276")
