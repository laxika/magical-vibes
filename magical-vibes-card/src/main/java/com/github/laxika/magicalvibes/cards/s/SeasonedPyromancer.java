...
public class SeasonedPyromancer extends Card {
    ...
    public SeasonedPyromancer() {
        ...
        CreateTokenEffect elementalToken = new CreateTokenEffect("Elemental", 1, 1,
                CardColor.RED, List.of(CardSubtype.ELEMENTAL), Set.of(), Set.of());
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD, SequenceEffect.of(
                new DiscardCardThenEffect(
                        null, elementalToken, "a card",
