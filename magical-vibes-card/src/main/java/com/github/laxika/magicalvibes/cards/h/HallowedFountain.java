...
@CardRegistration(set = "EXP", collectorNumber = "6")
@CardRegistration(set = "SLD", collectorNumber = "123")
@CardRegistration(set = "RVR", collectorNumber = "280")
@CardRegistration(set = "RVR", collectorNumber = "295")
