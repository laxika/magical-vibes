...
@CardRegistration(set = "MOM", collectorNumber = "18")
public class InfectedDefector extends Card {

    public InfectedDefector() {
        addEffect(EffectSlot.ON_DEATH, incubatorToken());
    }
