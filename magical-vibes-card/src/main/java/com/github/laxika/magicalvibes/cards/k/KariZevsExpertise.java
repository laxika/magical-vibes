...
@CardRegistration(set = "AER", collectorNumber = "88")
@CardRegistration(set = "KLR", collectorNumber = "134")
public class KariZevsExpertise extends Card {

    public KariZevsExpertise() {
