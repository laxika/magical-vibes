...
@CardRegistration(set = "3ED", collectorNumber = "9")
@CardRegistration(set = "2ED", collectorNumber = "10")
...
@CardRegistration(set = "ICE", collectorNumber = "12")
@CardRegistration(set = "TMP", collectorNumber = "8")
