...
@CardRegistration(set = "FIN", collectorNumber = "174")
public class BardsBow extends Card {
    ...
    public BardsBow() {
        ...
        addEffect(EffectSlot.STATIC, new GrantSubtypeEffect(CardSubtype.BARD, GrantScope.EQUIPPED_CREATURE));
