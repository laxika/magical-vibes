...
@CardRegistration(set = "MSC", collectorNumber = "514")
@CardRegistration(set = "MSC", collectorNumber = "835")
public class CaptainAmericaSteveRogers extends Card {

    public CaptainAmericaSteveRogers() {
