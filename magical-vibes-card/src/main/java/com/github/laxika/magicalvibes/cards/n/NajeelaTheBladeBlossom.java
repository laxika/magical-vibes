    ...
    public NajeelaTheBladeBlossom() {
        addEffect(EffectSlot.ON_ANY_CREATURE_ATTACKS,
                new TriggeringPermanentConditionalEffect(
                        ...
                        new MayEffect(
                                new CreateTokensAttackingEffect(
                                        1,
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Untap all attacking creatures. They gain trample, lifelink, and haste until end of turn. "
                        + "After this phase, there is an additional combat phase. Activate only during combat.",
