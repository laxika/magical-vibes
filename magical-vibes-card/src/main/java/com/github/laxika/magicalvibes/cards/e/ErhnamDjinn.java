...
public class ErhnamDjinn extends Card {
    ...
    public ErhnamDjinn() {
        // At the beginning of your upkeep, target non-Wall creature an opponent controls gains
        ...
        target(new PermanentPredicateTargetFilter(
                ...
                "Target must be a non-Wall creature an opponent controls"))
                .addEffect(EffectSlot.UPKEEP_TRIGGERED,
                        new GrantKeywordEffect(Keyword.FORESTWALK, GrantScope.TARGET,
