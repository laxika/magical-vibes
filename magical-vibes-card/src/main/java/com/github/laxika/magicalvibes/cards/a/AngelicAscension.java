...
@CardRegistration(set = "M21", collectorNumber = "3")
public class AngelicAscension extends Card {

    public AngelicAscension() {
        target(new PermanentPredicateTargetFilter(
                ...
                .addEffect(EffectSlot.SPELL, new ExileTargetPermanentEffect(new CreateTokenEffect(
                        ...
                        Set.of(Keyword.FLYING), Set.of(CardType.CREATURE))));
    }
}
