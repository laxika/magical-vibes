...
@CardRegistration(set = "MSH", collectorNumber = "34")
public class RedGuardianSuperSoldier extends Card {

    public RedGuardianSuperSoldier() {
        target(new PermanentPredicateTargetFilter(
                ...
                "Target must be a creature an opponent controls that dealt damage this turn"
