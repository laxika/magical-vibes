...
@CardRegistration(set = "10E", collectorNumber = "254")
...
@CardRegistration(set = "TPR", collectorNumber = "166")
@CardRegistration(set = "ATH", collectorNumber = "52")
@CardRegistration(set = "MB1", collectorNumber = "191")
