...
@CardRegistration(set = "BFZ", collectorNumber = "172")
public class EarthenArms extends Card {
    ...
    public EarthenArms() {
        addCastingOption(new AlternateHandCast(List.of(new ManaCastingCost("{6}{G}"))));
