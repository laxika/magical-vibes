...
@CardRegistration(set = "ONE", collectorNumber = "110")
public class StingingHivemaster extends Card {

    public StingingHivemaster() {
        addEffect(EffectSlot.ON_DEATH, miteToken());
    }
