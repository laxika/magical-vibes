...
@CardRegistration(set = "NEO", collectorNumber = "163")
public class SimianSling extends Card {
    ...
    public SimianSling() {
        ...
        addEffect(EffectSlot.ON_BECOMES_BLOCKED,
                new ConditionalEffect(new SourceIsCreature(), new DealDamageToAttackedTargetEffect(1)));
        addEffect(EffectSlot.ON_BECOMES_BLOCKED,
