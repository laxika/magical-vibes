...
@CardRegistration(set = "DDE", collectorNumber = "30")
@CardRegistration(set = "DDD", collectorNumber = "54")
@CardRegistration(set = "GVL", collectorNumber = "54")
@CardRegistration(set = "DDR", collectorNumber = "63")
