...
@CardRegistration(set = "SLD", collectorNumber = "1726")
public class CaptainAmericaFirstAvenger extends Card {
    ...
    public CaptainAmericaFirstAvenger() {
        addActivatedAbility(new ActivatedAbility(
                ...
                "{3}, Unattach an Equipment from Captain America: He deals damage equal to that Equipment's "
                        + "mana value divided as you choose among one, two, or three targets.",
                null, null, null, null, List.of(), 1, 3
        ));
