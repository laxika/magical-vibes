...
@CardRegistration(set = "AKR", collectorNumber = "260")
@CardRegistration(set = "MP2", collectorNumber = "54")
@CardRegistration(set = "SLD", collectorNumber = "904")
@CardRegistration(set = "ECC", collectorNumber = "133")
