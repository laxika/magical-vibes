...
@CardRegistration(set = "BFZ", collectorNumber = "23")
public class EncirclingFissure extends Card {
    ...
    public EncirclingFissure() {
        addCastingOption(new AlternateHandCast(List.of(new ManaCastingCost("{4}{W}"))));

        target(new PlayerPredicateTargetFilter(
                new PlayerRelationPredicate(PlayerRelation.OPPONENT),
                "Target must be an opponent"))
                .addEffect(EffectSlot.SPELL, PreventDamageEffect.allCombatByTargetOpponentCreatures());
