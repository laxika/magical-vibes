...
@CardRegistration(set = "SLD", collectorNumber = "1288")
@CardRegistration(set = "SLD", collectorNumber = "1865")
@CardRegistration(set = "PZA", collectorNumber = "19")
@CardRegistration(set = "AA3", collectorNumber = "23")
