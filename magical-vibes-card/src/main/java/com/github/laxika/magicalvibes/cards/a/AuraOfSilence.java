...
public class AuraOfSilence extends Card {
    ...
    public AuraOfSilence() {
        ...
        setStaticEffects(List.of(new IncreaseOpponentCastCostEffect(Set.of(CardType.ENCHANTMENT), 2)));
        setOnSacrificeEffects(List.of(new DestroyTargetPermanentEffect(Set.of(CardType.ENCHANTMENT))));
    }
}
