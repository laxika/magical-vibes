...
@CardRegistration(set = "MOM", collectorNumber = "170")
public class VolcanicSpite extends Card {

    public VolcanicSpite() {
        ...
        )).addEffect(EffectSlot.SPELL, new DealDamageToTargetPermanentEffect(3))
