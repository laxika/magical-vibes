...
@CardRegistration(set = "AVR", collectorNumber = "187")
public class NightshadePeddler extends Card {

    public NightshadePeddler() {
        ...
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                new MayEffect(new SoulbondChoosePartnerEffect(),
                        "Pair Nightshade Peddler with another unpaired creature you control?"));
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceIsPaired(),
                new GrantKeywordEffect(Keyword.DEATHTOUCH, GrantScope.SELF_AND_PAIRED)));
    }
}
