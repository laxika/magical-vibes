...
@CardRegistration(set = "ODY", collectorNumber = "139")
public class GhastlyDemise extends Card {

    public GhastlyDemise() {
        target(new PermanentPredicateTargetFilter(
                ...
                new TargetToughnessAtMostControllerGraveyardCount(),
