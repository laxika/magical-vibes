...
@CardRegistration(set = "4ED", collectorNumber = "271")
@CardRegistration(set = "5ED", collectorNumber = "325")
...
@CardRegistration(set = "2ED", collectorNumber = "217")
public class ShanodinDryads extends Card {

    public ShanodinDryads() {
        // Vanilla 1/1 with innate forestwalk (keyword auto-loaded from Scryfall).
    }
}
