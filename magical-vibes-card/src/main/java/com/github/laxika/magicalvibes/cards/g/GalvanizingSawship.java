...
@CardRegistration(set = "EOE", collectorNumber = "136")
public class GalvanizingSawship extends Card {

    public GalvanizingSawship() {
        ...
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceCounterThreshold(3, CounterType.CHARGE),
                new SetBasePowerToughnessEffect(6, 5, GrantScope.SELF)));
        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceCounterThreshold(3, CounterType.CHARGE),
