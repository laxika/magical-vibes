...
@CardRegistration(set = "ICE", collectorNumber = "290")
public class FloodedWoodlands extends Card {

    public FloodedWoodlands() {
        // Green creatures can't attack unless their controller sacrifices a land of their choice
