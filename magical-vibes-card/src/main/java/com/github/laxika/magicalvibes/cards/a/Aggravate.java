...
@CardRegistration(set = "AVR", collectorNumber = "125")
public class Aggravate extends Card {
    ...
    public Aggravate() {
        ...
        )).addEffect(EffectSlot.SPELL, new DealDamageToPermanentsTargetControlsEffect(1, true));
    }
}
