...
public class WasitoraNekoruQueen extends Card {
    ...
    public WasitoraNekoruQueen() {
        CreateTokenEffect catDragon = new CreateTokenEffect(
                1, "Cat Dragon", 3, 3, CardColor.BLACK,
                Set.of(CardColor.BLACK, CardColor.RED, CardColor.GREEN),
                List.of(CardSubtype.CAT, CardSubtype.DRAGON), Set.of(Keyword.FLYING), Set.of());
        addEffect(EffectSlot.ON_COMBAT_DAMAGE_TO_PLAYER,
                new TargetPlayerSacrificesCreatureOrControllerCreatesTokenEffect(catDragon));
    }
}
