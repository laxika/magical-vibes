...
@CardRegistration(set = "ALA", collectorNumber = "145")
public class RhoxCharger extends Card {

    public RhoxCharger() {
        // Trample is a keyword auto-loaded from Scryfall. Exalted: whenever a creature you control
