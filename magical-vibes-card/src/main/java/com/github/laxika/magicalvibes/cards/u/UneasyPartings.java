...
@CardRegistration(set = "HOB", collectorNumber = "58")
public class UneasyPartings extends Card {

    public UneasyPartings() {
        addEffect(EffectSlot.STATIC, new ReduceOwnCastCostIfTargetingPermanentEffect(
                new PermanentAllOfPredicate(List.of(
                        new PermanentIsCreaturePredicate(),
                        new PermanentIsAttackingPredicate(),
                        new PermanentNotPredicate(new PermanentIsTokenPredicate()))), 1));
