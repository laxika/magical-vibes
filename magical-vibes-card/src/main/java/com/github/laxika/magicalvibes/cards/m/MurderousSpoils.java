...
@CardRegistration(set = "DST", collectorNumber = "48")
public class MurderousSpoils extends Card {

    public MurderousSpoils() {
        target(new PermanentPredicateTargetFilter(
                ...
                .addEffect(EffectSlot.SPELL, new DestroyTargetNonblackCreatureAndGainControlOfAttachedEquipmentEffect());
    }
}
