...
@CardRegistration(set = "MUL", collectorNumber = "44")
@CardRegistration(set = "MUL", collectorNumber = "109")
@CardRegistration(set = "MUL", collectorNumber = "174")
@CardRegistration(set = "ECC", collectorNumber = "125")
