...
@CardRegistration(set = "ONS", collectorNumber = "8")
public class AvenSoulgazer extends Card {

    public AvenSoulgazer() {
        addActivatedAbility(new ActivatedAbility(false, "{2}{W}", List.of(new LookAtFaceDownCreatureEffect()),
