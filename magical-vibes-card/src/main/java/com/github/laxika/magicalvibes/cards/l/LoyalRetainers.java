...
@CardRegistration(set = "MSC", collectorNumber = "136")
@CardRegistration(set = "MSC", collectorNumber = "313")
@CardRegistration(set = "CMM", collectorNumber = "39")
@CardRegistration(set = "CMM", collectorNumber = "465")
