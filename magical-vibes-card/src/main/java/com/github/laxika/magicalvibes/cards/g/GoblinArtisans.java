...
import com.github.laxika.magicalvibes.model.filter.StackEntryNotTargetedByAnotherNamedCreatureAbilityPredicate;
...
public class GoblinArtisans extends Card {
    ...
    public GoblinArtisans() {
        addActivatedAbility(new ActivatedAbility(
                true,
                null,
                List.of(new FlipCoinWinEffect(new DrawCardEffect(1), new CounterSpellEffect())),
                ...
                new StackEntryPredicateTargetFilter(
                        new StackEntryAllOfPredicate(List.of(
                                ...
                                new StackEntryNotTargetedByAnotherNamedCreatureAbilityPredicate(
                                        "Goblin Artisans"))),
                        "Target must be an artifact spell you control that isn't targeted by another Goblin Artisans.")));
    }
}
