...
@CardRegistration(set = "ULG", collectorNumber = "20")
@CardRegistration(set = "VMA", collectorNumber = "40")
public class RadiantArchangel extends Card {

    public RadiantArchangel() {
