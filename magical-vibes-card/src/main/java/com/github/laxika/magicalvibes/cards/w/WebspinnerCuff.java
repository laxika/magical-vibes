...
@CardRegistration(set = "NEO", collectorNumber = "214")
public class WebspinnerCuff extends Card {

    public WebspinnerCuff() {
        addEffect(EffectSlot.STATIC, new StaticBoostEffect(1, 4, GrantScope.EQUIPPED_CREATURE));
