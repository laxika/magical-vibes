...
@CardRegistration(set = "FCA", collectorNumber = "15")
@CardRegistration(set = "CMM", collectorNumber = "274")
@CardRegistration(set = "CMM", collectorNumber = "554")
@CardRegistration(set = "CMM", collectorNumber = "679")
