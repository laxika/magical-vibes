...
@CardRegistration(set = "EOE", collectorNumber = "249")
public class WurmwallSweeper extends Card {

    public WurmwallSweeper() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                "Tap another creature you control: Put charge counters equal to its power on Wurmwall Sweeper.",
                ActivationTimingRestriction.SORCERY_SPEED
        ));

        addEffect(EffectSlot.STATIC, new ConditionalEffect(
                new SourceCounterThreshold(4, CounterType.CHARGE),
