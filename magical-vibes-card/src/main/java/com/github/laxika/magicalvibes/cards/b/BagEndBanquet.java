...
@CardRegistration(set = "HOC", collectorNumber = "5")
public class BagEndBanquet extends Card {

    public BagEndBanquet() {
        ...
        addActivatedAbility(new ActivatedAbility(
                ...
                List.of(new AwardManaEffect(ManaColor.COLORLESS,
                        new PermanentCount(new PermanentHasSubtypePredicate(CardSubtype.FOOD),
