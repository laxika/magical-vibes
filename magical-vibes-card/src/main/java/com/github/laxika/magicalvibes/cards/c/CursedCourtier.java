...
@CardRegistration(set = "WOE", collectorNumber = "9")
public class CursedCourtier extends Card {

    public CursedCourtier() {
        addEffect(EffectSlot.ON_ENTER_BATTLEFIELD,
                new CreateTokenAttachedToSourceEffect(cursedRoleToken()));
    }
