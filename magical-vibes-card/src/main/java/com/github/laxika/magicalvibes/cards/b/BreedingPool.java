...
@CardRegistration(set = "EXP", collectorNumber = "15")
@CardRegistration(set = "SLD", collectorNumber = "132")
@CardRegistration(set = "RVR", collectorNumber = "275")
@CardRegistration(set = "RVR", collectorNumber = "293")
