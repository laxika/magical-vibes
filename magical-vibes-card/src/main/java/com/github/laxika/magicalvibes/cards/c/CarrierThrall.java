...
@CardRegistration(set = "2X2", collectorNumber = "72")
@CardRegistration(set = "CMM", collectorNumber = "142")
public class CarrierThrall extends Card {
    ...
    public CarrierThrall() {
        addEffect(EffectSlot.ON_DEATH, ELDRAZI_SCION);
    }
}
