...
@CardRegistration(set = "MSC", collectorNumber = "15")
@CardRegistration(set = "MSC", collectorNumber = "307")
public class HatutZerazeStrikeForce extends Card {

    public HatutZerazeStrikeForce() {
        addEffect(EffectSlot.ON_SELF_CAST, new CopyThisSpellForEachCommanderCastEffect());
