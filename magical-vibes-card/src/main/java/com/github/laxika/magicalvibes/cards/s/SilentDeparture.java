...
@CardRegistration(set = "INR", collectorNumber = "367")
@CardRegistration(set = "EMA", collectorNumber = "72")
@CardRegistration(set = "HA3", collectorNumber = "8")
@CardRegistration(set = "SIS", collectorNumber = "22")
