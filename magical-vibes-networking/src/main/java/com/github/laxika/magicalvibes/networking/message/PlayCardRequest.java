...
public record PlayCardRequest(int cardIndex, Integer xValue, UUID targetId, Map<UUID, Integer> damageAssignments,
                              ...
                              UUID chosenAdditionalCostObjectId, List<UUID> casualtyCreatureIds, UUID commandCardId) {
    public PlayCardRequest(int cardIndex, Integer xValue, UUID targetId, Map<UUID, Integer> damageAssignments,
                              ...
                              Boolean alternateCost,
                              Boolean giftPromised,
                              UUID chosenAdditionalCostObjectId, List<UUID> casualtyCreatureIds) {
        this(cardIndex, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds, fromGraveyard, sacrificePermanentId, phyrexianLifeCount, fromExileCardId, alternateCostSacrificePermanentIds, flashback, exileGraveyardCardIndex, exileGraveyardCardIndices, kicked, fromLibraryTop, chosenGraveyardType, discardHandCardIndex, discardHandCardIndices, imposedSacrificePermanentIds, additionalCostSacrificePermanentIds, repeatedAdditionalCosts, buyback, sharedColorDiscardHandCardIndex, beholdPermanentId, beholdHandCardIndex, beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds, beholdCreatureType, morph, chosenCreatureType, foretell, waterbendPaid, payLifeForAdditionalCost, adventure, alternateCost, giftPromised, chosenAdditionalCostObjectId, casualtyCreatureIds, null);
    }
    public PlayCardRequest withoutCommandSource() {
        return new PlayCardRequest(0, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds, fromGraveyard, sacrificePermanentId, phyrexianLifeCount, fromExileCardId, alternateCostSacrificePermanentIds, flashback, exileGraveyardCardIndex, exileGraveyardCardIndices, kicked, fromLibraryTop, chosenGraveyardType, discardHandCardIndex, discardHandCardIndices, imposedSacrificePermanentIds, additionalCostSacrificePermanentIds, repeatedAdditionalCosts, buyback, sharedColorDiscardHandCardIndex, beholdPermanentId, beholdHandCardIndex, beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds, beholdCreatureType, morph, chosenCreatureType, foretell, waterbendPaid, payLifeForAdditionalCost, adventure, alternateCost, giftPromised, chosenAdditionalCostObjectId, casualtyCreatureIds, null);
    }
    public PlayCardRequest withCommandSource(UUID id) {
        return new PlayCardRequest(0, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds, fromGraveyard, sacrificePermanentId, phyrexianLifeCount, fromExileCardId, alternateCostSacrificePermanentIds, flashback, exileGraveyardCardIndex, exileGraveyardCardIndices, kicked, fromLibraryTop, chosenGraveyardType, discardHandCardIndex, discardHandCardIndices, imposedSacrificePermanentIds, additionalCostSacrificePermanentIds, repeatedAdditionalCosts, buyback, sharedColorDiscardHandCardIndex, beholdPermanentId, beholdHandCardIndex, beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds, beholdCreatureType, morph, chosenCreatureType, foretell, waterbendPaid, payLifeForAdditionalCost, adventure, alternateCost, giftPromised, chosenAdditionalCostObjectId, casualtyCreatureIds, id);
    }
    ...
    public PlayCardRequest(int cardIndex, Integer xValue, UUID targetId, Map<UUID, Integer> damageAssignments,
        ...
        this(cardIndex, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds, fromGraveyard, sacrificePermanentId, phyrexianLifeCount, fromExileCardId, alternateCostSacrificePermanentIds, flashback, exileGraveyardCardIndex, exileGraveyardCardIndices, kicked, fromLibraryTop, chosenGraveyardType, discardHandCardIndex, discardHandCardIndices, imposedSacrificePermanentIds, additionalCostSacrificePermanentIds, repeatedAdditionalCosts, buyback, sharedColorDiscardHandCardIndex, beholdPermanentId, beholdHandCardIndex, beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds, beholdCreatureType, morph, chosenCreatureType, foretell, waterbendPaid, payLifeForAdditionalCost, adventure, alternateCost, giftPromised, chosenAdditionalCostObjectId, null);
    }
    ...
    public PlayCardRequest(int cardIndex, Integer xValue, UUID targetId,
        ...
        this(cardIndex, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds,
                ...
                beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds,
                 ...
                 payLifeForAdditionalCost, adventure, alternateCost, null, null);
     }
    ...
    public PlayCardRequest(int cardIndex, Integer xValue, UUID targetId,
                           ...
                           List<UUID> exileCounterCostPermanentIds, String beholdCreatureType,
                           Boolean morph, String chosenCreatureType, Boolean foretell,
                           Boolean adventure, UUID chosenAdditionalCostObjectId) {
        this(cardIndex, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds,
                fromGraveyard, sacrificePermanentId, phyrexianLifeCount, fromExileCardId,
                alternateCostSacrificePermanentIds, flashback, exileGraveyardCardIndex,
                exileGraveyardCardIndices, kicked, fromLibraryTop, chosenGraveyardType,
                ...
                sharedColorDiscardHandCardIndex, beholdPermanentId, beholdHandCardIndex,
                beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds,
                beholdCreatureType, morph, chosenCreatureType, foretell, null, null,
                adventure, null, null, chosenAdditionalCostObjectId);
    }
    ...
    public PlayCardRequest(int cardIndex, Integer xValue, UUID targetId, Map<UUID, Integer> damageAssignments,
        ...
        this(cardIndex, xValue, targetId, damageAssignments, targetIds, convokeCreatureIds,
                ...
                sharedColorDiscardHandCardIndex, beholdPermanentId, beholdHandCardIndex,
                beholdPermanentIds, beholdHandCardIndices, exileCounterCostPermanentIds,
                beholdCreatureType, morph, chosenCreatureType, null, null, null, null, null, null, null);
    }
