...
class GaeasHeraldTest extends BaseCardTest {
    ...
    void protectsOpponentsCreatureSpellsFromCounterspells() {
        ...
        harness.setHand(player1, List.of(new RemoveSoul()));
    ...
    void doesNotProtectNonCreatureSpells() {
        ...
        addCreatureReady(player2, new DaringApprentice());

        harness.castInstant(player1, 0, harness.getPermanentId(player1, "Grizzly Bears"));
        harness.passPriority(player1);
        harness.activateAbility(player2, 0, null, might.getId());
        harness.passBothPriorities();

        harness.assertInGraveyard(player1, "Might of Oaks");
        harness.assertInGraveyard(player2, "Daring Apprentice");
        assertThat(gd.stack)
