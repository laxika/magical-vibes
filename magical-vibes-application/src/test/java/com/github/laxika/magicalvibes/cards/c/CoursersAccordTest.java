...
class CoursersAccordTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Creates a 3/3 Centaur, then populate copies it when it is the only creature token")
    void populateCopiesTheNewCentaur() {
        ...
        assertThat(centaurs).allSatisfy(centaur -> {
