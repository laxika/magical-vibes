...
@CardUsed({SupplyRunners.class, GrizzlyBears.class})
class SupplyRunnersTest extends BaseCardTest {
    ...
    void putsCountersOnOtherCreaturesYouControl() {
        ...
        harness.setHand(player1, List.of(new SupplyRunners()));
        ...
        Permanent supplyRunners = findPermanent(player1, "Supply Runners");
