...
class InkfathomInfiltratorTest extends BaseCardTest {
    ...
    void cannotBeBlocked() {
        ...
        Permanent attacker = new Permanent(new InkfathomInfiltrator());
    ...
    void cannotBlock() {
        Permanent infiltrator = new Permanent(new InkfathomInfiltrator());
        infiltrator.setSummoningSick(false);
        gd.playerBattlefields.get(player2.getId()).add(infiltrator);
