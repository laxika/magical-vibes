...
class PromisingVeinTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Search ability costs one mana and sacrifices Promising Vein")
    void searchAbilityCostsOneManaAndSacrificesItself() {
        harness.addToBattlefield(player1, new PromisingVein());
    ...
    @Test
    @DisplayName("Search ability offers basic lands and puts the chosen land onto the battlefield tapped")
