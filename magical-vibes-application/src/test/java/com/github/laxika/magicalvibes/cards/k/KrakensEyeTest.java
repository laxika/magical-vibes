...
class KrakensEyeTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Kraken's Eye has correct card properties")
    void hasCorrectProperties() {
        KrakensEye card = new KrakensEye();
        ...
        assertThat(trigger.spellFilter()).isEqualTo(new CardColorPredicate(CardColor.BLUE));
