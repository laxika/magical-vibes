...
@CardUsed({Disenchant.class, SolRing.class, Crusade.class, Ornithopter.class, GrizzlyBears.class})
class DisenchantTest extends BaseCardTest {
    ...
    void resolvesAndDestroysEnchantment() {
        ...
        UUID targetId = harness.getPermanentId(player2, "Crusade");
        harness.castAndResolveInstant(player1, 0, targetId);

        harness.assertNotOnBattlefield(player2, "Crusade");
