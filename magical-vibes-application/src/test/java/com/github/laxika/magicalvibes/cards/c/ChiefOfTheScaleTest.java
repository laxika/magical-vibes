...
class ChiefOfTheScaleTest extends BaseCardTest {
    ...
    void doesNotBoostItself() {
        ...
        Permanent chief = findPermanent(player1, "Chief of the Scale");
    ...
    void onlyBoostsOtherOwnWarriors() {
        ...
        harness.addToBattlefield(player2, new ChiefOfTheScale());

        Permanent bears = findPermanent(player1, "Grizzly Bears");
        Permanent opponentChief = findPermanent(player2, "Chief of the Scale");
