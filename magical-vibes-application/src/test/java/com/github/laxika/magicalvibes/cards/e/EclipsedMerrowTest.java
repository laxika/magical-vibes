...
@CardUsed({EclipsedMerrow.class, MerfolkOfThePearlTrident.class, Plains.class, Island.class, Swamp.class})
class EclipsedMerrowTest extends BaseCardTest {
    ...
    void etbOffersMatchingCards() {
        ...
        setupTopCards(List.of(merfolk, new Swamp(), plains, island));
        castAndResolveEtb();
    ...
    void choosingMatchingCardPutsItIntoHand() {
        Island island = new Island();
        setupTopCards(List.of(island, new Swamp(), new Swamp(), new Swamp()));
        castAndResolveEtb();
    ...
    void decliningBottomsEverything() {
        Plains plains = new Plains();
        setupTopCards(List.of(plains, new Swamp(), new Swamp(), new Swamp()));
        castAndResolveEtb();
    ...
    void noMatchingCardNeedsNoChoice() {
        setupTopCards(List.of(new Swamp(), new Swamp(), new Swamp(), new Swamp()));
        castAndResolveEtb();
