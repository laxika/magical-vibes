...
class ConcordantCrossroadsTest extends BaseCardTest {
    ...
    void ownCreaturesHaveHaste() {
        ...
        addPermanent(player1, new ConcordantCrossroads());
    ...
    @Test
    @DisplayName("Haste is removed when Concordant Crossroads leaves the battlefield")
    void hasteRemovedWhenSourceLeaves() {
        ...
        gd.playerBattlefields.get(player1.getId())
                .removeIf(p -> p.getCard().getName().equals("Concordant Crossroads"));
