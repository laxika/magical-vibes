...
@CardUsed({CircleOfProtectionBlue.class, GrizzlyBears.class, MerfolkOfThePearlTrident.class,
        Mountain.class, ProdigalSorcerer.class, VolcanicEruption.class})
class CircleOfProtectionBlueTest extends BaseCardTest {
    ...
    private Permanent addReadyCircle(Player player) {
        return harness.addToBattlefieldAndReturn(player, new CircleOfProtectionBlue());
    }
