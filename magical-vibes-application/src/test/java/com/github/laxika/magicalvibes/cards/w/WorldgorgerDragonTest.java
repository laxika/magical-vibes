...
@CardUsed({WorldgorgerDragon.class, GrizzlyBears.class, RiftstonePortal.class, Threaten.class})
class WorldgorgerDragonTest extends BaseCardTest {
    ...
    private void castWorldgorgerDragon() {
        harness.forceActivePlayer(player1);
        harness.forceStep(TurnStep.PRECOMBAT_MAIN);
        harness.castFromHand(player1, new WorldgorgerDragon(), "{3}{R}{R}{R}");
    }

    private void castThreaten(Permanent target) {
        harness.forceActivePlayer(player1);
        harness.forceStep(TurnStep.PRECOMBAT_MAIN);
