...
class BottomlessVaultTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Controller may choose to untap Bottomless Vault")
    ...
    @Test
    @DisplayName("Upkeep trigger occurs only during Bottomless Vault's controller's upkeep")
    ...
    @Test
    @DisplayName("Upkeep trigger does nothing if Bottomless Vault becomes untapped before resolution")
    void upkeepTriggerDoesNothingIfVaultBecomesUntappedBeforeResolution() {
        Permanent vault = harness.addToBattlefieldAndReturn(player1, new BottomlessVault());
        vault.tap();
