...
@CardUsed({GoblinGardener.class, Forest.class, Shock.class, GrizzlyBears.class})
class GoblinGardenerTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("If no land remains, the death trigger has no legal target")
    void noTriggerWhenNoLandIsAvailable() {
        harness.addToBattlefield(player1, new GoblinGardener());
