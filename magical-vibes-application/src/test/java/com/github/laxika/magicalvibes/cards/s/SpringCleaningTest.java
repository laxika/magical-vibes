...
@CardUsed({SpringCleaning.class, AngelicChorus.class, DeathPitsOfRath.class, Forest.class, GrizzlyBears.class})
class SpringCleaningTest extends BaseCardTest {
    ...
    void wonClashDestroysAllOpponentEnchantments() {
        ...
        harness.assertNotOnBattlefield(player2, "Death Pits of Rath");
    ...
    void lostClashDestroysOnlyTarget() {
        ...
        harness.assertNotOnBattlefield(player2, "Angelic Chorus");
        harness.assertOnBattlefield(player2, "Death Pits of Rath");
