...
@CardUsed({TurbulentFen.class, Forest.class})
class TurbulentFenTest extends BaseCardTest {
    ...
    void tappingForBlackProducesMana() {
        Permanent fen = addReadyFen(player1);
    ...
    private Permanent findFen(Player player) {
        return findPermanent(player, "Turbulent Fen");
    }
