...
@CardUsed({StormchaserMage.class, Shock.class, GrizzlyBears.class})
class StormchaserMageTest extends BaseCardTest {

    @Test
    @DisplayName("Prowess gives Stormchaser Mage +1/+1 when its controller casts a noncreature spell")
    ...
    private Permanent addReadyMage() {
        Permanent mage = harness.addToBattlefieldAndReturn(player1, new StormchaserMage());
