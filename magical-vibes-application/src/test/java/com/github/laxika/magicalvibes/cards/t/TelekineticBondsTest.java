...
@CardUsed({TelekineticBonds.class, CabalTherapy.class})
class TelekineticBondsTest extends BaseCardTest {
    ...
    void opponentDiscardPayTapsTargetPermanent() {
        ...
        harness.setHand(player2, List.of(new TelekineticBonds()));
        ...
        harness.handleListChoice(player1, "Telekinetic Bonds");
