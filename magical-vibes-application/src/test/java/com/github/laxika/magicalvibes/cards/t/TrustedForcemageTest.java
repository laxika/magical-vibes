...
class TrustedForcemageTest extends BaseCardTest {
    ...
    private Permanent castAndPairWithBears() {
        ...
        harness.setHand(player1, List.of(new TrustedForcemage()));
    ...
    void soulbondPairsOnEnter() {
        ...
        assertThat(forcemage.getPairedWithId()).isEqualTo(bears.getId());
        assertThat(bears.getPairedWithId()).isEqualTo(forcemage.getId());
    }
