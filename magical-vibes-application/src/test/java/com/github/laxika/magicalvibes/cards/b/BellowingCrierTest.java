...
@CardUsed({BellowingCrier.class, GrizzlyBears.class, Shock.class})
class BellowingCrierTest extends BaseCardTest {
    ...
    void entersAndLoots() {
        ...
        harness.setHand(player1, List.of(new BellowingCrier(), discard));
