...
@CardUsed({TurbulentSprings.class, Forest.class})
class TurbulentSpringsTest extends BaseCardTest {
    ...
    private void playTurbulentSprings() {
    ...
    private Permanent findSprings(Player player) {
        return findPermanent(player, "Turbulent Springs");
    }
