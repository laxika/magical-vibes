...
class DispersalShieldTest extends BaseCardTest {
    ...
    void doesNotCounterSpellAboveGreatestControlledPermanentManaValue() {
        ...
        harness.castFromHand(player1, spell, "{3}{W}{W}");
    ...
    @Test
    @DisplayName("Counters a zero-mana spell when you control no permanents")
    void countersZeroManaSpellWithoutControlledPermanents() {
        Ornithopter spell = new Ornithopter();
    ...
    @Test
    @DisplayName("Includes the announced X value in the target spell's mana value")
    void includesAnnouncedXValueInTargetSpellManaValue() {
        harness.addToBattlefield(player2, new GiantSpider());
