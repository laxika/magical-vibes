...
class SundownPassTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Sundown Pass has conditional enters-tapped effect")
    void hasConditionalEntersTappedEffect() {
        SundownPass card = new SundownPass();
    ...
    @Test
    @DisplayName("Sundown Pass has two mana abilities for red and white")
