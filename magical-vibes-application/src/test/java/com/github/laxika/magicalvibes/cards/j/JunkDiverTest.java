...
class JunkDiverTest extends BaseCardTest {
    ...
    void returnsTargetArtifactCard() {
        Card junkDiver = new JunkDiver();
        Card artifact = new TormodsCrypt();
        harness.addToBattlefield(player1, junkDiver);
        ...
        assertThat(gd.playerGraveyards.get(player1.getId()))
                .anyMatch(card -> card.getId().equals(junkDiver.getId()));
    }
    ...
    void excludesItselfFromTargets() {
        ...
        assertThat(choice.validCardIds()).doesNotContain(junkDiver.getId());
    }
    ...
    void requiresAnotherArtifactInOwnGraveyard() {
        harness.addToBattlefield(player1, new JunkDiver());
