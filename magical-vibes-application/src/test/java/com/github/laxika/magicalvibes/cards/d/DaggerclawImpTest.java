...
class DaggerclawImpTest extends BaseCardTest {
    ...
    void cannotBeBlockedByNonFlyingCreature() {
        Permanent attacker = addReadyCreature(player1, new DaggerclawImp());
        attacker.setAttacking(true);
