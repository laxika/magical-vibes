...
class TheDrossPitsTest extends BaseCardTest {

    @Test
    @DisplayName("Enters the battlefield tapped")
    void entersTapped() {
        harness.setHand(player1, List.of(new TheDrossPits()));
    ...
    @Test
    @DisplayName("Paying one generic and one black mana sacrifices the land and draws a card")
