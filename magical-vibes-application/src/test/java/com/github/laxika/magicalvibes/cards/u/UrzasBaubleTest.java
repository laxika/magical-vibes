...
class UrzasBaubleTest extends BaseCardTest {
    ...
    void activatingSacrificesAndSchedulesDraw() {
        ...
        harness.setHand(player2, List.of(new UrzasBauble()));
    ...
    @Test
    @DisplayName("Still schedules its draw when the target player's hand is empty")
    void schedulesDrawWithEmptyTargetHand() {
        harness.addToBattlefield(player1, new UrzasBauble());
