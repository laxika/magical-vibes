...
@CardUsed({QuietSpeculation.class, BattleScreech.class, FlaringPain.class, PrismaticStrands.class,
        RayOfRevelation.class, SuntailHawk.class})
class QuietSpeculationTest extends BaseCardTest {
    ...
    void offersOnlyFlashbackCards() {
        ...
        harness.setLibrary(player2, List.of(battleScreech, suntailHawk, rayOfRevelation));
        ...
        assertThat(search.params().cards()).containsExactly(battleScreech, rayOfRevelation);
    }
    ...
    void putsUpToThreeFlashbackCardsIntoTargetGraveyard() {
        ...
        Card suntailHawk = new SuntailHawk();
        harness.setLibrary(player2, List.of(battleScreech, rayOfRevelation, prismaticStrands, suntailHawk));
        ...
        assertThat(gd.playerGraveyards.get(player1.getId()))
                .doesNotContain(battleScreech, rayOfRevelation, prismaticStrands);
        assertThat(gd.playerDecks.get(player2.getId())).containsExactly(suntailHawk);
    ...
    void canChooseFewerThanThreeCards() {
        Card battleScreech = new BattleScreech();
        Card rayOfRevelation = new RayOfRevelation();
        harness.setLibrary(player2, List.of(battleScreech, rayOfRevelation));
        ...
        assertThat(gd.playerDecks.get(player2.getId())).containsExactly(rayOfRevelation);
        assertThat(gd.interaction.activeInteraction(PendingInteraction.LibrarySearch.class)).isNull();
    }
    ...
    void noMatchingCardsSkipsSearch() {
        Card suntailHawk = new SuntailHawk();
        harness.setLibrary(player2, List.of(suntailHawk));
