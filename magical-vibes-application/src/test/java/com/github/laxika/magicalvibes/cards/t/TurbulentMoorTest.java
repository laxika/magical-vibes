...
@CardUsed({TurbulentMoor.class, Forest.class})
class TurbulentMoorTest extends BaseCardTest {
    ...
    void tappingForWhiteProducesMana() {
        Permanent moor = addReadyMoor(player1);
    ...
    private void playTurbulentMoor() {
        harness.setHand(player1, List.of(new TurbulentMoor()));
    ...
    private Permanent findMoor(Player player) {
        return findPermanent(player, "Turbulent Moor");
    }
