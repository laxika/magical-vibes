...
class NayaPanoramaTest extends BaseCardTest {
    ...
    void searchPresentsOnlyMountainForestPlains() {
        ...
        assertThat(gd.playerBattlefields.get(player1.getId()))
                .noneMatch(p -> p.getCard().getName().equals("Naya Panorama"));
        assertThat(gd.playerGraveyards.get(player1.getId()))
                .anyMatch(c -> c.getName().equals("Naya Panorama"));
    ...
    private void setupLibrary() {
        ...
        deck.clear();
        deck.addAll(List.of(new Mountain(), new Forest(), new Plains(), new Swamp(), new Island(), new GrizzlyBears()));
    }
}
