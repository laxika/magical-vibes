...
@CardUsed({Gravestorm.class, DuskImp.class})
class GravestormTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("A single card is automatically exiled when the opponent accepts")
    void opponentExilesOnlyCardWithoutAnotherChoice() {
        harness.addToBattlefield(player1, new Gravestorm());
    ...
    @Test
    @DisplayName("Declining the exile allows the controller to draw")
    ...
    @Test
    @DisplayName("The controller may decline the draw after the opponent declines")
