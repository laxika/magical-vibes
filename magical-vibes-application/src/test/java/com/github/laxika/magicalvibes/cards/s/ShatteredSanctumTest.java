...
class ShatteredSanctumTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Shattered Sanctum has conditional enters-tapped effect")
    void hasConditionalEntersTappedEffect() {
        ShatteredSanctum card = new ShatteredSanctum();
    ...
    @Test
    @DisplayName("Shattered Sanctum has two mana abilities for white and black")
