...
class TempleOfMaladyTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Temple of Malady enters the battlefield tapped")
    ...
    @Test
    @DisplayName("Resolving Temple of Malady's enter trigger opens a scry 1 interaction")
    ...
    @Test
    @DisplayName("Temple of Malady produces the chosen black or green mana")
    void producesChosenMana() {
        for (ManaColor color : List.of(ManaColor.BLACK, ManaColor.GREEN)) {
    ...
    private Permanent findTemple(Player player) {
        return findPermanent(player, "Temple of Malady");
    }
}
