...
class MakindiShieldmateTest extends BaseCardTest {
    ...
    void ownAllyEntryMayPutCounterOnIt() {
        harness.setHand(player1, List.of(new MakindiShieldmate()));
    ...
    @Test
    @DisplayName("Another Ally entry triggers Makindi Shieldmate")
    void anotherAllyEntryTriggersShieldmate() {
