...
class SmolderingCraterTest extends BaseCardTest {
    ...
    void tappingProducesRedMana() {
        Permanent smolderingCrater = addSmolderingCraterReady(player1);
    ...
    private Permanent addSmolderingCraterReady(Player player) {
        Permanent perm = new Permanent(new SmolderingCrater());
