...
class KukemssaPiratesTest extends BaseCardTest {
    ...
    private Permanent addAttacker() {
        Permanent atk = new Permanent(new KukemssaPirates());
    ...
    void acceptGainsControlAndPreventsDamage() {
        ...
        assertThat(gd.playerBattlefields.get(player1.getId())).contains(millstone);
    ...
    void nonArtifactsAreNotOffered() {
        // Defender controls a land and a creature but no artifact.
