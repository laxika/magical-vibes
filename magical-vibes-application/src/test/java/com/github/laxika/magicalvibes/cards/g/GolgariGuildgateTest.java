...
class GolgariGuildgateTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Golgari Guildgate enters the battlefield tapped")
    void entersBattlefieldTapped() {
        ...
        Permanent guildgate = findPermanent(player1, "Golgari Guildgate");
        assertThat(guildgate.isTapped()).isTrue();
    }

    @Test
    @DisplayName("Activating the ability prompts a choice between black and green")
