...
class TerritorialBalothTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Landfall gives Territorial Baloth +2/+2 until end of turn")
    void landfallBoostsTerritorialBaloth() {
    ...
    @Test
    @DisplayName("An opponent's land does not trigger Territorial Baloth")
