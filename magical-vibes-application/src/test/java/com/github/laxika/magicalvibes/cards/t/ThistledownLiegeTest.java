...
class ThistledownLiegeTest extends BaseCardTest {
    ...
    void buffsOtherWhite() {
        ...
        Permanent white = findPermanent(player1, "Elite Vanguard");
    ...
    void doesNotBuffItself() {
        ...
        Permanent liege = findPermanent(player1, "Thistledown Liege");
    ...
    void doesNotBuffOpponent() {
        ...
        Permanent opponentWhite = findPermanent(player2, "Elite Vanguard");
