...
class TempleOfEpiphanyTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Temple of Epiphany enters the battlefield tapped")
    ...
    @Test
    @DisplayName("Resolving Temple of Epiphany's enter trigger opens a scry 1 interaction")
    ...
    @Test
    @DisplayName("Temple of Epiphany produces the chosen blue or red mana")
    void producesChosenMana() {
        for (ManaColor color : List.of(ManaColor.BLUE, ManaColor.RED)) {
    ...
    private Permanent findTemple(Player player) {
        return findPermanent(player, "Temple of Epiphany");
    }
}
