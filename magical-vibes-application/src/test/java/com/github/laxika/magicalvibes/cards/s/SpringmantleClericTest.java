...
class SpringmantleClericTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Colorless mana does not add a counter")
    void colorlessManaDoesNotAddCounter() {
        ...
        assertThat(gqs.getEffectivePower(gd, cleric)).isEqualTo(2);
    ...
    void colorlessManaAlongsideColoredManaCountsOnlyColors() {
        ...
        assertThat(cleric.getCounterCount(CounterType.PLUS_ONE_PLUS_ONE)).isEqualTo(2);
    }
