...
class FloodPlainTest extends BaseCardTest {
    ...
    void entersTapped() {
        ...
        Permanent plain = gd.playerBattlefields.get(player1.getId()).stream()
                .filter(p -> p.getCard().getName().equals("Flood Plain"))
                .findFirst()
                .orElseThrow();
    ...
    private void setupLibrary() {
        ...
        deck.clear();
        deck.addAll(List.of(new Plains(), new Island(), new Swamp(), new Mountain(), new GrizzlyBears()));
    }
}
