...
class TempleOfEnlightenmentTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Temple of Enlightenment enters the battlefield tapped")
    ...
    @Test
    @DisplayName("Resolving Temple of Enlightenment's enter trigger opens a scry 1 interaction")
    ...
    private void playTempleOfEnlightenment(Player player) {
        harness.setHand(player, List.of(new TempleOfEnlightenment()));
    ...
    private Permanent findTemple(Player player) {
        return findPermanent(player, "Temple of Enlightenment");
    }
}
