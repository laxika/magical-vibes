...
@CardUsed({AdamaroFirstToDesire.class, HandOfHonor.class})
class AdamaroFirstToDesireTest extends BaseCardTest {
    ...
    void powerAndToughnessEqualLargestOpponentHandSize() {
        harness.setHand(player1, List.of(new HandOfHonor(), new HandOfHonor(), new HandOfHonor(), new HandOfHonor(), new HandOfHonor()));
    ...
    @Test
    @DisplayName("Uses the current controller's opponent's hand")
    void usesCurrentControllersOpponentHand() {
        harness.setHand(player1, List.of(new HandOfHonor(), new HandOfHonor(), new HandOfHonor(), new HandOfHonor()));
        harness.setHand(player2, List.of(new HandOfHonor()));
        Permanent adamaro = harness.addToBattlefieldAndReturn(player2, new AdamaroFirstToDesire());
