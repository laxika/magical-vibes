...
class PromisedKannushiTest extends BaseCardTest {
    ...
    private void wrathToKillKannushi() {
    ...
    void deathReturnsCheapSpiritToHand() {
        harness.addToBattlefield(player1, new PromisedKannushi());
    ...
    void expensiveOrOpponentSpiritNotTargetable() {
        ...
        Card expensiveSpirit = new PromisedKannushi();
    ...
    void noLegalSpiritNoChoice() {
        harness.addToBattlefield(player1, new PromisedKannushi());
        harness.setGraveyard(player1, new ArrayList<>(List.of(new PromisedKannushi())));
