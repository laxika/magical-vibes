...
class AtarkaMonumentTest extends BaseCardTest {
    ...
    @Test
    @DisplayName("Tapping Atarka Monument adds one red or green mana")
    ...
    @Test
    @DisplayName("Paying four generic, red, and green mana animates Atarka Monument")
    ...
    @Test
    @DisplayName("Atarka Monument stops being a creature at end of turn")
