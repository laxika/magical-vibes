...
class VineKamiTest extends BaseCardTest {
    ...
    /** Wraths the board so Vine Kami dies, firing its soulshift trigger. */
    ...
    void deathReturnsCheapSpiritToHand() {
        ...
        Card spirit = new SibilantSpirit();
    ...
    @Test
    @DisplayName("Spirits with mana value 7 or greater and an opponent's Spirits are not legal targets")
    void expensiveOrOpponentSpiritNotTargetable() {
        harness.addToBattlefield(player1, new VineKami());
        Card cheapSpirit = new SibilantSpirit();
