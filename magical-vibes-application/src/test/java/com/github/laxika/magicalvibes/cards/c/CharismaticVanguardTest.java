...
@CardUsed({CharismaticVanguard.class, GrizzlyBears.class})
class CharismaticVanguardTest extends BaseCardTest {

    @Test
    @DisplayName("Paying {4}{W} gives creatures you control +1/+1 until end of turn")
