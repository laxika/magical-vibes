 ...
 *
 * <ul>
 *   <li>{@link #CONTROLLER} — "your library". Read from the stack entry's {@code controllerId}; when
 *       the controller is also the decision-maker, the effect declares no {@code TargetSpec}, so a
 *       card carrying it may still target something else (Discombobulate counters target spell,
 *       then looks at its controller's own library).</li>
