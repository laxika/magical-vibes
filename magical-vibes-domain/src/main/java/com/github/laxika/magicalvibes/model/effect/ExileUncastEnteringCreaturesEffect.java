 ...
 * (Hallowed Moonlight.)
 *
 * <p>Adds the controller to {@code GameData.playersExilingUncastEnteringCreaturesThisTurn}. It is a
 ...
 */
public record ExileUncastEnteringCreaturesEffect() implements CardEffect {
}
