...
/**
 * Exiles a target card from any graveyard, then creates the supplied token under that card's
 * owner's control.
 */
public record ExileTargetCardFromGraveyardCreateTokenForOwnerEffect(CreateTokenEffect tokenTemplate)
