...
public class ManaPool {
    ...
    /** Mana carrying the rider "if spent to cast a commander, it enters with commander-cast counters". */
    ...
    /** Total mana still carrying Opal Palace's commander-cast counter rider. */
