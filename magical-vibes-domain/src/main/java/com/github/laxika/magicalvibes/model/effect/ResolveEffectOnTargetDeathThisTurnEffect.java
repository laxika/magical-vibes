...
/**
 * Registers a delayed trigger: when the targeted creature dies this turn, the wrapped effect
 ...
 * {@code GameData.creatureTriggeringEffectOnDeathThisTurn} keyed by the creature's card ID. When
 * that creature dies later in the same turn, the death pipeline pushes a triggered ability that
 ...
 *
 * @param effect the effect to resolve when the targeted creature dies this turn
 */
