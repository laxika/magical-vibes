...
/**
 * Creates a token from a fixed blueprint and links the first token created to the source permanent.
 * The link is used by the source and token leaves-the-battlefield triggers.
 */
