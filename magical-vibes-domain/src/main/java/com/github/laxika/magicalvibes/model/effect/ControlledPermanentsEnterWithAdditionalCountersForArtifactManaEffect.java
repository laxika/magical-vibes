 ...
 * amount of artifact-produced mana spent to cast the entering permanent.
 */
public record ControlledPermanentsEnterWithAdditionalCountersForArtifactManaEffect(
    ...
    public int additionalCounterCount(GameData gameData, Permanent enteringPermanent) {
        return gameData.getSpellCastArtifactManaSpent(enteringPermanent.getCard().getId());
    }
}
