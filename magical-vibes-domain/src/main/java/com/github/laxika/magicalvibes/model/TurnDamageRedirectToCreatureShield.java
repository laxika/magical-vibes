 ...
 * Damage dealt to the destination creature itself is left alone.
 *
...
public record TurnDamageRedirectToCreatureShield(UUID protectedPlayerId,
    ...
    public TurnDamageRedirectToCreatureShield(UUID protectedPlayerId, UUID redirectTargetCreatureId,
        ...
        this(protectedPlayerId, redirectTargetCreatureId, combatOnly, includeControlledPermanents, null);
    }

    public TurnDamageRedirectToCreatureShield(UUID protectedPlayerId, UUID redirectTargetCreatureId) {
        this(protectedPlayerId, redirectTargetCreatureId, false, true, null);
    }
}
