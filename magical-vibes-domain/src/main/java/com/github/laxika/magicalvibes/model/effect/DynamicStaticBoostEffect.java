 ...
 * or optionally from the affected permanent and its controller. This is the dynamic counterpart
 * to {@link StaticBoostEffect} for anthem effects such as "+0/+1 for each Gate you control".
 */
