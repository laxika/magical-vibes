 ...
 *
 * <p>The kicker cost can be a mana cost, a life payment, a sacrifice cost, a tap cost, a
 * return-to-hand cost, or a forage.
 *
...
public record KickerEffect(String cost, PermanentPredicate sacrificePredicate, String sacrificeDescription,
    ...
    public KickerEffect(String cost, PermanentPredicate sacrificePredicate, String sacrificeDescription,
        ...
        this(cost, sacrificePredicate, sacrificeDescription, tapPredicate, tapDescription, null, null, null, null,
                sacrificePredicate == null ? 0 : 1, null, null, false, null);
    }
    ...
    public KickerEffect(PayLifeCost lifeCost) {
        this(null, null, null, null, null, null, null, null, null, 0, lifeCost, null, false, null);
    }
    ...
    /** Convenience factory for a kicker paid by foraging. */
    public static KickerEffect forage() {
        return new KickerEffect(null, null, null, null, null, null, null, null, null, 0, null, null, false,
    ...
    public boolean hasForageCost() {
        return forageCost != null;
    }
