 ...
 * are animated (Living Lands = all Forests become 1/1). The layer-4 type change is applied by the
 * layered pass; the base P/T and creature-ness are filled in the accumulator pass by the matching
 * handler, and combat/targeting queries recognise animated lands via
 * {@code GameQueryService.matchesAnimateLand}.
 */
