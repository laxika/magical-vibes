 ...
 * {@code GameData.permanentAbilityResolutionsThisTurn} whenever an ability whose effects carry
 * this condition resolves (counting resolutions, not activations, so copies of the ability count
 * but abilities countered on the stack do not), and this condition is met
