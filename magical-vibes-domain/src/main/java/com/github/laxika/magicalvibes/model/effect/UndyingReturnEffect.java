...
/**
 * Undying (CR 702.93): "When this creature dies, if it had no +1/+1 counters on it, return it to the
 * battlefield under its owner's control with a +1/+1 counter on it."
 *
 * <p>This effect is the resolution half of the Undying triggered ability. The "if it had no +1/+1
 ...
 */
public record UndyingReturnEffect() implements CardEffect {
}
