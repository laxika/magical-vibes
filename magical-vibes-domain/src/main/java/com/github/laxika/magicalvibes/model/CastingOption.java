 ...
 */
public sealed interface CastingOption permits FlashbackCast, DisturbCast, AlternateHandCast, BestowCast, GraveyardCast, ExileCast, Retrace, JumpStartCast, MiracleCast, MadnessCast {
