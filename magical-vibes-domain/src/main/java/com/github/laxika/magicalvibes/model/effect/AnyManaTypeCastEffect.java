 ...
 * spells of certain card types or subtypes (e.g. Vizier of the Menagerie: "You can spend mana of
 * any type to cast creature spells"). Colored mana requirements of a matching spell may be paid
 * with mana of any type, including colorless.
 *
...
public interface AnyManaTypeCastEffect extends CardEffect {
    ...
    /** Card subtypes whose spells this permanent lets the controller cast with mana of any type. */
    default Set<CardSubtype> spellSubtypes() {
        return Set.of();
    }
}
