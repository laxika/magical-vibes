 ...
 * @param manaCost the mana cost that must be paid to avoid the sacrifice
 */
public record AllPermanentsUpkeepSacrificeUnlessPayEffect(PermanentPredicate filter, String manaCost)
