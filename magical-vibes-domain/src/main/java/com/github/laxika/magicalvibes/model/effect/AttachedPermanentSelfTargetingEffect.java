...
/**
 * Marker for a self-targeting effect on an activated ability of an Aura or Equipment that must
 ...
 *
 * <p>{@code ActivatedAbilityExecutionService} captures {@code Permanent.getAttachedTo()} onto the
